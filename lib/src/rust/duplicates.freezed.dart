...
/// Adds pattern-matching-related methods to [LnUrlAuthError].
extension LnUrlAuthErrorPatterns on LnUrlAuthError {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( LnUrlAuthError_Generic value)?  generic,TResult Function( LnUrlAuthError_InvalidUri value)?  invalidUri,TResult Function( LnUrlAuthError_ServiceConnectivity value)?  serviceConnectivity,required TResult orElse(),}){
final _that = this;
switch (_that) {
case LnUrlAuthError_Generic() when generic != null:
return generic(_that);case LnUrlAuthError_InvalidUri() when invalidUri != null:
return invalidUri(_that);case LnUrlAuthError_ServiceConnectivity() when serviceConnectivity != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( LnUrlAuthError_Generic value)  generic,required TResult Function( LnUrlAuthError_InvalidUri value)  invalidUri,required TResult Function( LnUrlAuthError_ServiceConnectivity value)  serviceConnectivity,}){
final _that = this;
switch (_that) {
case LnUrlAuthError_Generic():
return generic(_that);case LnUrlAuthError_InvalidUri():
return invalidUri(_that);case LnUrlAuthError_ServiceConnectivity():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( LnUrlAuthError_Generic value)?  generic,TResult? Function( LnUrlAuthError_InvalidUri value)?  invalidUri,TResult? Function( LnUrlAuthError_ServiceConnectivity value)?  serviceConnectivity,}){
final _that = this;
switch (_that) {
case LnUrlAuthError_Generic() when generic != null:
return generic(_that);case LnUrlAuthError_InvalidUri() when invalidUri != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String err)?  generic,TResult Function( String err)?  invalidUri,TResult Function( String err)?  serviceConnectivity,required TResult orElse(),}) {final _that = this;
switch (_that) {
case LnUrlAuthError_Generic() when generic != null:
return generic(_that.err);case LnUrlAuthError_InvalidUri() when invalidUri != null:
return invalidUri(_that.err);case LnUrlAuthError_ServiceConnectivity() when serviceConnectivity != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String err)  generic,required TResult Function( String err)  invalidUri,required TResult Function( String err)  serviceConnectivity,}) {final _that = this;
switch (_that) {
case LnUrlAuthError_Generic():
return generic(_that.err);case LnUrlAuthError_InvalidUri():
return invalidUri(_that.err);case LnUrlAuthError_ServiceConnectivity():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String err)?  generic,TResult? Function( String err)?  invalidUri,TResult? Function( String err)?  serviceConnectivity,}) {final _that = this;
switch (_that) {
case LnUrlAuthError_Generic() when generic != null:
return generic(_that.err);case LnUrlAuthError_InvalidUri() when invalidUri != null:
return invalidUri(_that.err);case LnUrlAuthError_ServiceConnectivity() when serviceConnectivity != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  ok,TResult Function( LnUrlErrorData data)?  errorStatus,required TResult orElse(),}) {final _that = this;
switch (_that) {
case LnUrlCallbackStatus_Ok() when ok != null:
return ok();case LnUrlCallbackStatus_ErrorStatus() when errorStatus != null:
return errorStatus(_that.data);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  ok,required TResult Function( LnUrlErrorData data)  errorStatus,}) {final _that = this;
switch (_that) {
case LnUrlCallbackStatus_Ok():
return ok();case LnUrlCallbackStatus_ErrorStatus():
return errorStatus(_that.data);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  ok,TResult? Function( LnUrlErrorData data)?  errorStatus,}) {final _that = this;
switch (_that) {
case LnUrlCallbackStatus_Ok() when ok != null:
return ok();case LnUrlCallbackStatus_ErrorStatus() when errorStatus != null:
return errorStatus(_that.data);case _:
...
/// Adds pattern-matching-related methods to [LnUrlPayError].
extension LnUrlPayErrorPatterns on LnUrlPayError {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( LnUrlPayError_AlreadyPaid value)?  alreadyPaid,TResult Function( LnUrlPayError_Generic value)?  generic,TResult Function( LnUrlPayError_InsufficientBalance value)?  insufficientBalance,TResult Function( LnUrlPayError_InvalidAmount value)?  invalidAmount,TResult Function( LnUrlPayError_InvalidInvoice value)?  invalidInvoice,TResult Function( LnUrlPayError_InvalidNetwork value)?  invalidNetwork,TResult Function( LnUrlPayError_InvalidUri value)?  invalidUri,TResult Function( LnUrlPayError_InvoiceExpired value)?  invoiceExpired,TResult Function( LnUrlPayError_PaymentFailed value)?  paymentFailed,TResult Function( LnUrlPayError_PaymentTimeout value)?  paymentTimeout,TResult Function( LnUrlPayError_RouteNotFound value)?  routeNotFound,TResult Function( LnUrlPayError_RouteTooExpensive value)?  routeTooExpensive,TResult Function( LnUrlPayError_ServiceConnectivity value)?  serviceConnectivity,required TResult orElse(),}){
final _that = this;
switch (_that) {
case LnUrlPayError_AlreadyPaid() when alreadyPaid != null:
return alreadyPaid(_that);case LnUrlPayError_Generic() when generic != null:
return generic(_that);case LnUrlPayError_InsufficientBalance() when insufficientBalance != null:
return insufficientBalance(_that);case LnUrlPayError_InvalidAmount() when invalidAmount != null:
return invalidAmount(_that);case LnUrlPayError_InvalidInvoice() when invalidInvoice != null:
return invalidInvoice(_that);case LnUrlPayError_InvalidNetwork() when invalidNetwork != null:
return invalidNetwork(_that);case LnUrlPayError_InvalidUri() when invalidUri != null:
return invalidUri(_that);case LnUrlPayError_InvoiceExpired() when invoiceExpired != null:
return invoiceExpired(_that);case LnUrlPayError_PaymentFailed() when paymentFailed != null:
return paymentFailed(_that);case LnUrlPayError_PaymentTimeout() when paymentTimeout != null:
return paymentTimeout(_that);case LnUrlPayError_RouteNotFound() when routeNotFound != null:
return routeNotFound(_that);case LnUrlPayError_RouteTooExpensive() when routeTooExpensive != null:
return routeTooExpensive(_that);case LnUrlPayError_ServiceConnectivity() when serviceConnectivity != null:
return serviceConnectivity(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( LnUrlPayError_AlreadyPaid value)  alreadyPaid,required TResult Function( LnUrlPayError_Generic value)  generic,required TResult Function( LnUrlPayError_InsufficientBalance value)  insufficientBalance,required TResult Function( LnUrlPayError_InvalidAmount value)  invalidAmount,required TResult Function( LnUrlPayError_InvalidInvoice value)  invalidInvoice,required TResult Function( LnUrlPayError_InvalidNetwork value)  invalidNetwork,required TResult Function( LnUrlPayError_InvalidUri value)  invalidUri,required TResult Function( LnUrlPayError_InvoiceExpired value)  invoiceExpired,required TResult Function( LnUrlPayError_PaymentFailed value)  paymentFailed,required TResult Function( LnUrlPayError_PaymentTimeout value)  paymentTimeout,required TResult Function( LnUrlPayError_RouteNotFound value)  routeNotFound,required TResult Function( LnUrlPayError_RouteTooExpensive value)  routeTooExpensive,required TResult Function( LnUrlPayError_ServiceConnectivity value)  serviceConnectivity,}){
final _that = this;
switch (_that) {
case LnUrlPayError_AlreadyPaid():
return alreadyPaid(_that);case LnUrlPayError_Generic():
return generic(_that);case LnUrlPayError_InsufficientBalance():
return insufficientBalance(_that);case LnUrlPayError_InvalidAmount():
return invalidAmount(_that);case LnUrlPayError_InvalidInvoice():
return invalidInvoice(_that);case LnUrlPayError_InvalidNetwork():
return invalidNetwork(_that);case LnUrlPayError_InvalidUri():
return invalidUri(_that);case LnUrlPayError_InvoiceExpired():
return invoiceExpired(_that);case LnUrlPayError_PaymentFailed():
return paymentFailed(_that);case LnUrlPayError_PaymentTimeout():
return paymentTimeout(_that);case LnUrlPayError_RouteNotFound():
return routeNotFound(_that);case LnUrlPayError_RouteTooExpensive():
return routeTooExpensive(_that);case LnUrlPayError_ServiceConnectivity():
return serviceConnectivity(_that);}
}
/// A variant of `map` that fallback to returning `null`.
///
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( LnUrlPayError_AlreadyPaid value)?  alreadyPaid,TResult? Function( LnUrlPayError_Generic value)?  generic,TResult? Function( LnUrlPayError_InsufficientBalance value)?  insufficientBalance,TResult? Function( LnUrlPayError_InvalidAmount value)?  invalidAmount,TResult? Function( LnUrlPayError_InvalidInvoice value)?  invalidInvoice,TResult? Function( LnUrlPayError_InvalidNetwork value)?  invalidNetwork,TResult? Function( LnUrlPayError_InvalidUri value)?  invalidUri,TResult? Function( LnUrlPayError_InvoiceExpired value)?  invoiceExpired,TResult? Function( LnUrlPayError_PaymentFailed value)?  paymentFailed,TResult? Function( LnUrlPayError_PaymentTimeout value)?  paymentTimeout,TResult? Function( LnUrlPayError_RouteNotFound value)?  routeNotFound,TResult? Function( LnUrlPayError_RouteTooExpensive value)?  routeTooExpensive,TResult? Function( LnUrlPayError_ServiceConnectivity value)?  serviceConnectivity,}){
final _that = this;
switch (_that) {
case LnUrlPayError_AlreadyPaid() when alreadyPaid != null:
return alreadyPaid(_that);case LnUrlPayError_Generic() when generic != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  alreadyPaid,TResult Function( String err)?  generic,TResult Function( String err)?  insufficientBalance,TResult Function( String err)?  invalidAmount,TResult Function( String err)?  invalidInvoice,TResult Function( String err)?  invalidNetwork,TResult Function( String err)?  invalidUri,TResult Function( String err)?  invoiceExpired,TResult Function( String err)?  paymentFailed,TResult Function( String err)?  paymentTimeout,TResult Function( String err)?  routeNotFound,TResult Function( String err)?  routeTooExpensive,TResult Function( String err)?  serviceConnectivity,required TResult orElse(),}) {final _that = this;
switch (_that) {
case LnUrlPayError_AlreadyPaid() when alreadyPaid != null:
return alreadyPaid();case LnUrlPayError_Generic() when generic != null:
return generic(_that.err);case LnUrlPayError_InsufficientBalance() when insufficientBalance != null:
return insufficientBalance(_that.err);case LnUrlPayError_InvalidAmount() when invalidAmount != null:
return invalidAmount(_that.err);case LnUrlPayError_InvalidInvoice() when invalidInvoice != null:
return invalidInvoice(_that.err);case LnUrlPayError_InvalidNetwork() when invalidNetwork != null:
return invalidNetwork(_that.err);case LnUrlPayError_InvalidUri() when invalidUri != null:
return invalidUri(_that.err);case LnUrlPayError_InvoiceExpired() when invoiceExpired != null:
return invoiceExpired(_that.err);case LnUrlPayError_PaymentFailed() when paymentFailed != null:
return paymentFailed(_that.err);case LnUrlPayError_PaymentTimeout() when paymentTimeout != null:
return paymentTimeout(_that.err);case LnUrlPayError_RouteNotFound() when routeNotFound != null:
return routeNotFound(_that.err);case LnUrlPayError_RouteTooExpensive() when routeTooExpensive != null:
return routeTooExpensive(_that.err);case LnUrlPayError_ServiceConnectivity() when serviceConnectivity != null:
return serviceConnectivity(_that.err);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  alreadyPaid,required TResult Function( String err)  generic,required TResult Function( String err)  insufficientBalance,required TResult Function( String err)  invalidAmount,required TResult Function( String err)  invalidInvoice,required TResult Function( String err)  invalidNetwork,required TResult Function( String err)  invalidUri,required TResult Function( String err)  invoiceExpired,required TResult Function( String err)  paymentFailed,required TResult Function( String err)  paymentTimeout,required TResult Function( String err)  routeNotFound,required TResult Function( String err)  routeTooExpensive,required TResult Function( String err)  serviceConnectivity,}) {final _that = this;
switch (_that) {
case LnUrlPayError_AlreadyPaid():
return alreadyPaid();case LnUrlPayError_Generic():
return generic(_that.err);case LnUrlPayError_InsufficientBalance():
return insufficientBalance(_that.err);case LnUrlPayError_InvalidAmount():
return invalidAmount(_that.err);case LnUrlPayError_InvalidInvoice():
return invalidInvoice(_that.err);case LnUrlPayError_InvalidNetwork():
return invalidNetwork(_that.err);case LnUrlPayError_InvalidUri():
return invalidUri(_that.err);case LnUrlPayError_InvoiceExpired():
return invoiceExpired(_that.err);case LnUrlPayError_PaymentFailed():
return paymentFailed(_that.err);case LnUrlPayError_PaymentTimeout():
return paymentTimeout(_that.err);case LnUrlPayError_RouteNotFound():
return routeNotFound(_that.err);case LnUrlPayError_RouteTooExpensive():
return routeTooExpensive(_that.err);case LnUrlPayError_ServiceConnectivity():
return serviceConnectivity(_that.err);}
}
/// A variant of `when` that fallback to returning `null`
///
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  alreadyPaid,TResult? Function( String err)?  generic,TResult? Function( String err)?  insufficientBalance,TResult? Function( String err)?  invalidAmount,TResult? Function( String err)?  invalidInvoice,TResult? Function( String err)?  invalidNetwork,TResult? Function( String err)?  invalidUri,TResult? Function( String err)?  invoiceExpired,TResult? Function( String err)?  paymentFailed,TResult? Function( String err)?  paymentTimeout,TResult? Function( String err)?  routeNotFound,TResult? Function( String err)?  routeTooExpensive,TResult? Function( String err)?  serviceConnectivity,}) {final _that = this;
switch (_that) {
case LnUrlPayError_AlreadyPaid() when alreadyPaid != null:
return alreadyPaid();case LnUrlPayError_Generic() when generic != null:
return generic(_that.err);case LnUrlPayError_InsufficientBalance() when insufficientBalance != null:
...
/// Adds pattern-matching-related methods to [LnUrlWithdrawError].
extension LnUrlWithdrawErrorPatterns on LnUrlWithdrawError {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( LnUrlWithdrawError_Generic value)?  generic,TResult Function( LnUrlWithdrawError_InvalidAmount value)?  invalidAmount,TResult Function( LnUrlWithdrawError_InvalidInvoice value)?  invalidInvoice,TResult Function( LnUrlWithdrawError_InvalidUri value)?  invalidUri,TResult Function( LnUrlWithdrawError_InvoiceNoRoutingHints value)?  invoiceNoRoutingHints,TResult Function( LnUrlWithdrawError_ServiceConnectivity value)?  serviceConnectivity,required TResult orElse(),}){
final _that = this;
switch (_that) {
case LnUrlWithdrawError_Generic() when generic != null:
return generic(_that);case LnUrlWithdrawError_InvalidAmount() when invalidAmount != null:
return invalidAmount(_that);case LnUrlWithdrawError_InvalidInvoice() when invalidInvoice != null:
return invalidInvoice(_that);case LnUrlWithdrawError_InvalidUri() when invalidUri != null:
return invalidUri(_that);case LnUrlWithdrawError_InvoiceNoRoutingHints() when invoiceNoRoutingHints != null:
return invoiceNoRoutingHints(_that);case LnUrlWithdrawError_ServiceConnectivity() when serviceConnectivity != null:
return serviceConnectivity(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( LnUrlWithdrawError_Generic value)  generic,required TResult Function( LnUrlWithdrawError_InvalidAmount value)  invalidAmount,required TResult Function( LnUrlWithdrawError_InvalidInvoice value)  invalidInvoice,required TResult Function( LnUrlWithdrawError_InvalidUri value)  invalidUri,required TResult Function( LnUrlWithdrawError_InvoiceNoRoutingHints value)  invoiceNoRoutingHints,required TResult Function( LnUrlWithdrawError_ServiceConnectivity value)  serviceConnectivity,}){
final _that = this;
switch (_that) {
case LnUrlWithdrawError_Generic():
return generic(_that);case LnUrlWithdrawError_InvalidAmount():
return invalidAmount(_that);case LnUrlWithdrawError_InvalidInvoice():
return invalidInvoice(_that);case LnUrlWithdrawError_InvalidUri():
return invalidUri(_that);case LnUrlWithdrawError_InvoiceNoRoutingHints():
return invoiceNoRoutingHints(_that);case LnUrlWithdrawError_ServiceConnectivity():
return serviceConnectivity(_that);}
}
/// A variant of `map` that fallback to returning `null`.
///
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( LnUrlWithdrawError_Generic value)?  generic,TResult? Function( LnUrlWithdrawError_InvalidAmount value)?  invalidAmount,TResult? Function( LnUrlWithdrawError_InvalidInvoice value)?  invalidInvoice,TResult? Function( LnUrlWithdrawError_InvalidUri value)?  invalidUri,TResult? Function( LnUrlWithdrawError_InvoiceNoRoutingHints value)?  invoiceNoRoutingHints,TResult? Function( LnUrlWithdrawError_ServiceConnectivity value)?  serviceConnectivity,}){
final _that = this;
switch (_that) {
case LnUrlWithdrawError_Generic() when generic != null:
return generic(_that);case LnUrlWithdrawError_InvalidAmount() when invalidAmount != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String err)?  generic,TResult Function( String err)?  invalidAmount,TResult Function( String err)?  invalidInvoice,TResult Function( String err)?  invalidUri,TResult Function( String err)?  invoiceNoRoutingHints,TResult Function( String err)?  serviceConnectivity,required TResult orElse(),}) {final _that = this;
switch (_that) {
case LnUrlWithdrawError_Generic() when generic != null:
return generic(_that.err);case LnUrlWithdrawError_InvalidAmount() when invalidAmount != null:
return invalidAmount(_that.err);case LnUrlWithdrawError_InvalidInvoice() when invalidInvoice != null:
return invalidInvoice(_that.err);case LnUrlWithdrawError_InvalidUri() when invalidUri != null:
return invalidUri(_that.err);case LnUrlWithdrawError_InvoiceNoRoutingHints() when invoiceNoRoutingHints != null:
return invoiceNoRoutingHints(_that.err);case LnUrlWithdrawError_ServiceConnectivity() when serviceConnectivity != null:
return serviceConnectivity(_that.err);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String err)  generic,required TResult Function( String err)  invalidAmount,required TResult Function( String err)  invalidInvoice,required TResult Function( String err)  invalidUri,required TResult Function( String err)  invoiceNoRoutingHints,required TResult Function( String err)  serviceConnectivity,}) {final _that = this;
switch (_that) {
case LnUrlWithdrawError_Generic():
return generic(_that.err);case LnUrlWithdrawError_InvalidAmount():
return invalidAmount(_that.err);case LnUrlWithdrawError_InvalidInvoice():
return invalidInvoice(_that.err);case LnUrlWithdrawError_InvalidUri():
return invalidUri(_that.err);case LnUrlWithdrawError_InvoiceNoRoutingHints():
return invoiceNoRoutingHints(_that.err);case LnUrlWithdrawError_ServiceConnectivity():
return serviceConnectivity(_that.err);}
}
/// A variant of `when` that fallback to returning `null`
///
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String err)?  generic,TResult? Function( String err)?  invalidAmount,TResult? Function( String err)?  invalidInvoice,TResult? Function( String err)?  invalidUri,TResult? Function( String err)?  invoiceNoRoutingHints,TResult? Function( String err)?  serviceConnectivity,}) {final _that = this;
switch (_that) {
case LnUrlWithdrawError_Generic() when generic != null:
return generic(_that.err);case LnUrlWithdrawError_InvalidAmount() when invalidAmount != null:
return invalidAmount(_that.err);case LnUrlWithdrawError_InvalidInvoice() when invalidInvoice != null:
...
/// Adds pattern-matching-related methods to [LnUrlWithdrawResult].
extension LnUrlWithdrawResultPatterns on LnUrlWithdrawResult {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( LnUrlWithdrawResult_Ok value)?  ok,TResult Function( LnUrlWithdrawResult_Timeout value)?  timeout,TResult Function( LnUrlWithdrawResult_ErrorStatus value)?  errorStatus,required TResult orElse(),}){
final _that = this;
switch (_that) {
case LnUrlWithdrawResult_Ok() when ok != null:
return ok(_that);case LnUrlWithdrawResult_Timeout() when timeout != null:
return timeout(_that);case LnUrlWithdrawResult_ErrorStatus() when errorStatus != null:
return errorStatus(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( LnUrlWithdrawResult_Ok value)  ok,required TResult Function( LnUrlWithdrawResult_Timeout value)  timeout,required TResult Function( LnUrlWithdrawResult_ErrorStatus value)  errorStatus,}){
final _that = this;
switch (_that) {
case LnUrlWithdrawResult_Ok():
return ok(_that);case LnUrlWithdrawResult_Timeout():
return timeout(_that);case LnUrlWithdrawResult_ErrorStatus():
return errorStatus(_that);}
}
/// A variant of `map` that fallback to returning `null`.
///
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( LnUrlWithdrawResult_Ok value)?  ok,TResult? Function( LnUrlWithdrawResult_Timeout value)?  timeout,TResult? Function( LnUrlWithdrawResult_ErrorStatus value)?  errorStatus,}){
final _that = this;
switch (_that) {
case LnUrlWithdrawResult_Ok() when ok != null:
return ok(_that);case LnUrlWithdrawResult_Timeout() when timeout != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( LnUrlWithdrawSuccessData data)?  ok,TResult Function( LnUrlWithdrawSuccessData data)?  timeout,TResult Function( LnUrlErrorData data)?  errorStatus,required TResult orElse(),}) {final _that = this;
switch (_that) {
case LnUrlWithdrawResult_Ok() when ok != null:
return ok(_that.data);case LnUrlWithdrawResult_Timeout() when timeout != null:
return timeout(_that.data);case LnUrlWithdrawResult_ErrorStatus() when errorStatus != null:
return errorStatus(_that.data);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( LnUrlWithdrawSuccessData data)  ok,required TResult Function( LnUrlWithdrawSuccessData data)  timeout,required TResult Function( LnUrlErrorData data)  errorStatus,}) {final _that = this;
switch (_that) {
case LnUrlWithdrawResult_Ok():
return ok(_that.data);case LnUrlWithdrawResult_Timeout():
return timeout(_that.data);case LnUrlWithdrawResult_ErrorStatus():
return errorStatus(_that.data);}
}
/// A variant of `when` that fallback to returning `null`
///
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( LnUrlWithdrawSuccessData data)?  ok,TResult? Function( LnUrlWithdrawSuccessData data)?  timeout,TResult? Function( LnUrlErrorData data)?  errorStatus,}) {final _that = this;
switch (_that) {
case LnUrlWithdrawResult_Ok() when ok != null:
return ok(_that.data);case LnUrlWithdrawResult_Timeout() when timeout != null:
return timeout(_that.data);case LnUrlWithdrawResult_ErrorStatus() when errorStatus != null:
