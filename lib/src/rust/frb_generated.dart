...
class FlutterBreezLiquid
    extends BaseEntrypoint<FlutterBreezLiquidApi, FlutterBreezLiquidApiImpl, FlutterBreezLiquidWire> {
  @internal
  static final instance = FlutterBreezLiquid._();

  FlutterBreezLiquid._();

  /// Initialize flutter_rust_bridge
  static Future<void> init({
    FlutterBreezLiquidApi? api,
    BaseHandler? handler,
  ...
  static void initMock({required FlutterBreezLiquidApi api}) {
  ...
  @override
  ApiImplConstructor<FlutterBreezLiquidApiImpl, FlutterBreezLiquidWire> get apiImplConstructor =>
      FlutterBreezLiquidApiImpl.new;

  @override
  WireConstructor<FlutterBreezLiquidWire> get wireConstructor => FlutterBreezLiquidWire.fromExternalLibrary;
...
abstract class FlutterBreezLiquidApi extends BaseApi {
  Future<AddConnectionResponse> crateNwcBreezNwcServiceAddConnection({
    required BreezNwcService that,
    required AddConnectionRequest req,
  });

  Stream<NwcEvent> crateNwcBreezNwcServiceAddEventListener({required BreezNwcService that});

  Future<EditConnectionResponse> crateNwcBreezNwcServiceEditConnection({
    required BreezNwcService that,
    required EditConnectionRequest req,
  });

  Future<NostrServiceInfo?> crateNwcBreezNwcServiceGetInfo({required BreezNwcService that});

  Future<void> crateNwcBreezNwcServiceHandleEvent({required BreezNwcService that, required String rawEvent});

  Future<String> crateNwcBreezNwcServiceId({required BreezNwcService that});

  Future<bool> crateNwcBreezNwcServiceIsZap({required BreezNwcService that, required String invoice});

  Future<List<Payment>> crateNwcBreezNwcServiceListConnectionPayments({
    required BreezNwcService that,
    required String name,
  });

  Future<Map<String, NwcConnection>> crateNwcBreezNwcServiceListConnections({required BreezNwcService that});

  BreezNwcService crateNwcBreezNwcServiceNew({required NwcConfig config});

  Future<void> crateNwcBreezNwcServiceOnStart({
    required BreezNwcService that,
    required PluginSdk pluginSdk,
    required PluginStorage storage,
  });

  Future<void> crateNwcBreezNwcServiceOnStop({required BreezNwcService that});

  Future<void> crateNwcBreezNwcServiceRemoveConnection({required BreezNwcService that, required String name});

  Future<void> crateNwcBreezNwcServiceTrackZap({
    required BreezNwcService that,
    required String invoice,
    required String zapRequest,
  });

  Future<void> crateSdkBreezSdkLiquidAcceptPaymentProposedFees({
    required BreezSdkLiquid that,
    required AcceptPaymentProposedFeesRequest req,
  });

  Stream<SdkEvent> crateSdkBreezSdkLiquidAddEventListener({required BreezSdkLiquid that});

  void crateSdkBreezSdkLiquidBackup({required BreezSdkLiquid that, required BackupRequest req});

  Future<String> crateSdkBreezSdkLiquidBuyBitcoin({
    required BreezSdkLiquid that,
    required BuyBitcoinRequest req,
  });

  CheckMessageResponse crateSdkBreezSdkLiquidCheckMessage({
    required BreezSdkLiquid that,
    required CheckMessageRequest req,
  });

  Future<CreateBolt12InvoiceResponse> crateSdkBreezSdkLiquidCreateBolt12Invoice({
    required BreezSdkLiquid that,
    required CreateBolt12InvoiceRequest req,
  });

  Future<void> crateSdkBreezSdkLiquidDisconnect({required BreezSdkLiquid that});

  void crateSdkBreezSdkLiquidEmptyWalletCache({required BreezSdkLiquid that});

  Future<List<Rate>> crateSdkBreezSdkLiquidFetchFiatRates({required BreezSdkLiquid that});

  Future<LightningPaymentLimitsResponse> crateSdkBreezSdkLiquidFetchLightningLimits({
    required BreezSdkLiquid that,
  });

  Future<OnchainPaymentLimitsResponse> crateSdkBreezSdkLiquidFetchOnchainLimits({
    required BreezSdkLiquid that,
  });

  Future<FetchPaymentProposedFeesResponse> crateSdkBreezSdkLiquidFetchPaymentProposedFees({
    required BreezSdkLiquid that,
    required FetchPaymentProposedFeesRequest req,
  });

  Future<GetInfoResponse> crateSdkBreezSdkLiquidGetInfo({required BreezSdkLiquid that});

  Future<Payment?> crateSdkBreezSdkLiquidGetPayment({
    required BreezSdkLiquid that,
    required GetPaymentRequest req,
  });

  Future<List<FiatCurrency>> crateSdkBreezSdkLiquidListFiatCurrencies({required BreezSdkLiquid that});

  Future<List<Payment>> crateSdkBreezSdkLiquidListPayments({
    required BreezSdkLiquid that,
    required ListPaymentsRequest req,
  });

  Future<List<RefundableSwap>> crateSdkBreezSdkLiquidListRefundables({required BreezSdkLiquid that});

  Future<LnUrlCallbackStatus> crateSdkBreezSdkLiquidLnurlAuth({
    required BreezSdkLiquid that,
    required LnUrlAuthRequestData reqData,
  });

  Future<LnUrlPayResult> crateSdkBreezSdkLiquidLnurlPay({
    required BreezSdkLiquid that,
    required LnUrlPayRequest req,
  });

  Future<LnUrlWithdrawResult> crateSdkBreezSdkLiquidLnurlWithdraw({
    required BreezSdkLiquid that,
    required LnUrlWithdrawRequest req,
  });

  Future<InputType> crateSdkBreezSdkLiquidParse({required BreezSdkLiquid that, required String input});

  Future<SendPaymentResponse> crateSdkBreezSdkLiquidPayOnchain({
    required BreezSdkLiquid that,
    required PayOnchainRequest req,
  });

  Future<PrepareBuyBitcoinResponse> crateSdkBreezSdkLiquidPrepareBuyBitcoin({
    required BreezSdkLiquid that,
    required PrepareBuyBitcoinRequest req,
  });

  Future<PrepareLnUrlPayResponse> crateSdkBreezSdkLiquidPrepareLnurlPay({
    required BreezSdkLiquid that,
    required PrepareLnUrlPayRequest req,
  });

  Future<PreparePayOnchainResponse> crateSdkBreezSdkLiquidPreparePayOnchain({
    required BreezSdkLiquid that,
    required PreparePayOnchainRequest req,
  });

  Future<PrepareReceiveResponse> crateSdkBreezSdkLiquidPrepareReceivePayment({
    required BreezSdkLiquid that,
    required PrepareReceiveRequest req,
  });

  Future<PrepareRefundResponse> crateSdkBreezSdkLiquidPrepareRefund({
    required BreezSdkLiquid that,
    required PrepareRefundRequest req,
  });

  Future<PrepareSendResponse> crateSdkBreezSdkLiquidPrepareSendPayment({
    required BreezSdkLiquid that,
    required PrepareSendRequest req,
  });

  Future<ReceivePaymentResponse> crateSdkBreezSdkLiquidReceivePayment({
    required BreezSdkLiquid that,
    required ReceivePaymentRequest req,
  });

  Future<RecommendedFees> crateSdkBreezSdkLiquidRecommendedFees({required BreezSdkLiquid that});

  Future<RefundResponse> crateSdkBreezSdkLiquidRefund({
    required BreezSdkLiquid that,
    required RefundRequest req,
  });

  Future<void> crateSdkBreezSdkLiquidRegisterWebhook({
    required BreezSdkLiquid that,
    required String webhookUrl,
  });

  Future<void> crateSdkBreezSdkLiquidRescanOnchainSwaps({required BreezSdkLiquid that});

  void crateSdkBreezSdkLiquidRestore({required BreezSdkLiquid that, required RestoreRequest req});

  Future<SendPaymentResponse> crateSdkBreezSdkLiquidSendPayment({
    required BreezSdkLiquid that,
    required SendPaymentRequest req,
  });

  SignMessageResponse crateSdkBreezSdkLiquidSignMessage({
    required BreezSdkLiquid that,
    required SignMessageRequest req,
  });

  Future<void> crateSdkBreezSdkLiquidSync({required BreezSdkLiquid that});

  Future<void> crateSdkBreezSdkLiquidUnregisterWebhook({required BreezSdkLiquid that});

  Future<BreezNwcService> crateSdkBreezSdkLiquidUseNwcPlugin({
    required BreezSdkLiquid that,
    required NwcConfig config,
  });

  Stream<SdkEvent> cratePluginPluginSdkAddEventListener({required PluginSdk that});

  Future<GetInfoResponse> cratePluginPluginSdkGetInfo({required PluginSdk that});

  Future<List<Payment>> cratePluginPluginSdkListPayments({
    required PluginSdk that,
    required ListPaymentsRequest req,
  });

  Future<InputType> cratePluginPluginSdkParse({required PluginSdk that, required String input});

  Future<PrepareReceiveResponse> cratePluginPluginSdkPrepareReceivePayment({
    required PluginSdk that,
    required PrepareReceiveRequest req,
  });

  Future<PrepareSendResponse> cratePluginPluginSdkPrepareSendPayment({
    required PluginSdk that,
    required PrepareSendRequest req,
  });

  Future<ReceivePaymentResponse> cratePluginPluginSdkReceivePayment({
    required PluginSdk that,
    required ReceivePaymentRequest req,
  });

  Future<SendPaymentResponse> cratePluginPluginSdkSendPayment({
    required PluginSdk that,
    required SendPaymentRequest req,
  });
  ...
  void cratePluginPluginStorageRemoveItem({required PluginStorage that, required String key});

  void cratePluginPluginStorageSetItem({
    required PluginStorage that,
    required String key,
    required String value,
    String? oldValue,
  });

  Future<void> crateEventsBreezEventListenerOnEvent({required BreezEventListener that, required SdkEvent e});

  Stream<LogEntry> crateLoggerBreezLogStream();

  Future<void> crateNwcEventBreezNwcEventListenerOnEvent({
    required BreezNwcEventListener that,
    required NwcEvent e,
  });

  Future<BreezSdkLiquid> crateSdkConnect({required ConnectRequest req});

  Config crateSdkDefaultConfig({required LiquidNetwork network, String? breezApiKey});

  LNInvoice crateSdkParseInvoice({required String input});

  RustArcIncrementStrongCountFnType get rust_arc_increment_strong_count_BreezNwcService;

  RustArcDecrementStrongCountFnType get rust_arc_decrement_strong_count_BreezNwcService;

  CrossPlatformFinalizerArg get rust_arc_decrement_strong_count_BreezNwcServicePtr;

  RustArcIncrementStrongCountFnType get rust_arc_increment_strong_count_BreezSdkLiquid;

  RustArcDecrementStrongCountFnType get rust_arc_decrement_strong_count_BreezSdkLiquid;

  CrossPlatformFinalizerArg get rust_arc_decrement_strong_count_BreezSdkLiquidPtr;

  RustArcIncrementStrongCountFnType get rust_arc_increment_strong_count_PluginSdk;

  RustArcDecrementStrongCountFnType get rust_arc_decrement_strong_count_PluginSdk;

  CrossPlatformFinalizerArg get rust_arc_decrement_strong_count_PluginSdkPtr;

  RustArcIncrementStrongCountFnType get rust_arc_increment_strong_count_PluginStorage;

  RustArcDecrementStrongCountFnType get rust_arc_decrement_strong_count_PluginStorage;

  CrossPlatformFinalizerArg get rust_arc_decrement_strong_count_PluginStoragePtr;
}

class FlutterBreezLiquidApiImpl extends FlutterBreezLiquidApiImplPlatform implements FlutterBreezLiquidApi {
  FlutterBreezLiquidApiImpl({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezNwcService(
            that,
            serializer,
          );
          sse_encode_box_autoadd_add_connection_request(req, serializer);
          pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 1, port: port_);
        },
        codec: SseCodec(
          decodeSuccessData: sse_decode_add_connection_response,
          decodeErrorData: sse_decode_nwc_error,
        ),
        constMeta: kCrateNwcBreezNwcServiceAddConnectionConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateNwcBreezNwcServiceAddConnectionConstMeta =>
      const TaskConstMeta(debugName: "BreezNwcService_add_connection", argNames: ["that", "req"]);

  @override
  Stream<NwcEvent> crateNwcBreezNwcServiceAddEventListener({required BreezNwcService that}) {
    final listener = RustStreamSink<NwcEvent>();
    unawaited(
      handler.executeNormal(
        NormalTask(
          callFfi: (port_) {
            ...
            sse_encode_StreamSink_nwc_event_Sse(listener, serializer);
            pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 2, port: port_);
          },
          codec: SseCodec(decodeSuccessData: sse_decode_String, decodeErrorData: null),
          constMeta: kCrateNwcBreezNwcServiceAddEventListenerConstMeta,
  ...
  TaskConstMeta get kCrateNwcBreezNwcServiceAddEventListenerConstMeta =>
      const TaskConstMeta(debugName: "BreezNwcService_add_event_listener", argNames: ["that", "listener"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_edit_connection_request(req, serializer);
          pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 3, port: port_);
        },
        codec: SseCodec(
          decodeSuccessData: sse_decode_edit_connection_response,
          decodeErrorData: sse_decode_nwc_error,
        ),
        constMeta: kCrateNwcBreezNwcServiceEditConnectionConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateNwcBreezNwcServiceEditConnectionConstMeta =>
      const TaskConstMeta(debugName: "BreezNwcService_edit_connection", argNames: ["that", "req"]);
  ...
  Future<NostrServiceInfo?> crateNwcBreezNwcServiceGetInfo({required BreezNwcService that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_opt_box_autoadd_nostr_service_info,
          decodeErrorData: null,
        ),
        constMeta: kCrateNwcBreezNwcServiceGetInfoConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateNwcBreezNwcServiceGetInfoConstMeta =>
      const TaskConstMeta(debugName: "BreezNwcService_get_info", argNames: ["that"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_String(rawEvent, serializer);
          pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 5, port: port_);
        },
        codec: SseCodec(decodeSuccessData: sse_decode_unit, decodeErrorData: sse_decode_nwc_error),
        constMeta: kCrateNwcBreezNwcServiceHandleEventConstMeta,
        argValues: [that, rawEvent],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateNwcBreezNwcServiceHandleEventConstMeta =>
      const TaskConstMeta(debugName: "BreezNwcService_handle_event", argNames: ["that", "rawEvent"]);
  ...
  Future<String> crateNwcBreezNwcServiceId({required BreezNwcService that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(decodeSuccessData: sse_decode_String, decodeErrorData: null),
        constMeta: kCrateNwcBreezNwcServiceIdConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateNwcBreezNwcServiceIdConstMeta =>
      const TaskConstMeta(debugName: "BreezNwcService_id", argNames: ["that"]);
  ...
  Future<bool> crateNwcBreezNwcServiceIsZap({required BreezNwcService that, required String invoice}) {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(decodeSuccessData: sse_decode_bool, decodeErrorData: sse_decode_nwc_error),
        constMeta: kCrateNwcBreezNwcServiceIsZapConstMeta,
  ...
  TaskConstMeta get kCrateNwcBreezNwcServiceIsZapConstMeta =>
      const TaskConstMeta(debugName: "BreezNwcService_is_zap", argNames: ["that", "invoice"]);
  ...
  Future<List<Payment>> crateNwcBreezNwcServiceListConnectionPayments({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(decodeSuccessData: sse_decode_list_payment, decodeErrorData: sse_decode_nwc_error),
        constMeta: kCrateNwcBreezNwcServiceListConnectionPaymentsConstMeta,
        argValues: [that, name],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateNwcBreezNwcServiceListConnectionPaymentsConstMeta =>
      const TaskConstMeta(debugName: "BreezNwcService_list_connection_payments", argNames: ["that", "name"]);
  ...
  Future<Map<String, NwcConnection>> crateNwcBreezNwcServiceListConnections({required BreezNwcService that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_Map_String_nwc_connection_None,
          decodeErrorData: sse_decode_nwc_error,
        ),
        constMeta: kCrateNwcBreezNwcServiceListConnectionsConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateNwcBreezNwcServiceListConnectionsConstMeta =>
      const TaskConstMeta(debugName: "BreezNwcService_list_connections", argNames: ["that"]);
  ...
  BreezNwcService crateNwcBreezNwcServiceNew({required NwcConfig config}) {
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_box_autoadd_nwc_config(config, serializer);
          return pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 10)!;
        },
        codec: SseCodec(
          decodeSuccessData:
              sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezNwcService,
          decodeErrorData: null,
        ),
        constMeta: kCrateNwcBreezNwcServiceNewConstMeta,
        argValues: [config],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateNwcBreezNwcServiceNewConstMeta =>
      const TaskConstMeta(debugName: "BreezNwcService_new", argNames: ["config"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginSdk(
            pluginSdk,
            serializer,
          );
          sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginStorage(
            storage,
            serializer,
          );
        ...
        constMeta: kCrateNwcBreezNwcServiceOnStartConstMeta,
        argValues: [that, pluginSdk, storage],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateNwcBreezNwcServiceOnStartConstMeta =>
      const TaskConstMeta(debugName: "BreezNwcService_on_start", argNames: ["that", "pluginSdk", "storage"]);
  ...
  Future<void> crateNwcBreezNwcServiceOnStop({required BreezNwcService that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(decodeSuccessData: sse_decode_unit, decodeErrorData: null),
        constMeta: kCrateNwcBreezNwcServiceOnStopConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateNwcBreezNwcServiceOnStopConstMeta =>
      const TaskConstMeta(debugName: "BreezNwcService_on_stop", argNames: ["that"]);

  @override
  Future<void> crateNwcBreezNwcServiceRemoveConnection({
    required BreezNwcService that,
    required String name,
  }) {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(decodeSuccessData: sse_decode_unit, decodeErrorData: sse_decode_nwc_error),
        constMeta: kCrateNwcBreezNwcServiceRemoveConnectionConstMeta,
        argValues: [that, name],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateNwcBreezNwcServiceRemoveConnectionConstMeta =>
      const TaskConstMeta(debugName: "BreezNwcService_remove_connection", argNames: ["that", "name"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_String(invoice, serializer);
          sse_encode_String(zapRequest, serializer);
          pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 14, port: port_);
        },
        codec: SseCodec(decodeSuccessData: sse_decode_unit, decodeErrorData: sse_decode_nwc_error),
        constMeta: kCrateNwcBreezNwcServiceTrackZapConstMeta,
        argValues: [that, invoice, zapRequest],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateNwcBreezNwcServiceTrackZapConstMeta => const TaskConstMeta(
    debugName: "BreezNwcService_track_zap",
    argNames: ["that", "invoice", "zapRequest"],
  );
  ...
  Future<void> crateSdkBreezSdkLiquidAcceptPaymentProposedFees({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezSdkLiquid(
            that,
            serializer,
          );
          sse_encode_box_autoadd_accept_payment_proposed_fees_request(req, serializer);
          pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 15, port: port_);
        },
        codec: SseCodec(decodeSuccessData: sse_decode_unit, decodeErrorData: sse_decode_payment_error),
        constMeta: kCrateSdkBreezSdkLiquidAcceptPaymentProposedFeesConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidAcceptPaymentProposedFeesConstMeta => const TaskConstMeta(
    debugName: "BreezSdkLiquid_accept_payment_proposed_fees",
    argNames: ["that", "req"],
  );
    ...
    unawaited(
      handler.executeNormal(
        NormalTask(
          ...
          codec: SseCodec(decodeSuccessData: sse_decode_String, decodeErrorData: sse_decode_sdk_error),
          constMeta: kCrateSdkBreezSdkLiquidAddEventListenerConstMeta,
          argValues: [that, listener],
          apiImpl: this,
        ),
      ),
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidAddEventListenerConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_add_event_listener", argNames: ["that", "listener"]);
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          ...
          sse_encode_box_autoadd_backup_request(req, serializer);
          return pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 17)!;
        },
        codec: SseCodec(decodeSuccessData: sse_decode_unit, decodeErrorData: sse_decode_sdk_error),
        constMeta: kCrateSdkBreezSdkLiquidBackupConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidBackupConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_backup", argNames: ["that", "req"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_buy_bitcoin_request(req, serializer);
          pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 18, port: port_);
        },
        codec: SseCodec(decodeSuccessData: sse_decode_String, decodeErrorData: sse_decode_payment_error),
        constMeta: kCrateSdkBreezSdkLiquidBuyBitcoinConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidBuyBitcoinConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_buy_bitcoin", argNames: ["that", "req"]);
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          ...
          sse_encode_box_autoadd_check_message_request(req, serializer);
        ...
        constMeta: kCrateSdkBreezSdkLiquidCheckMessageConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidCheckMessageConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_check_message", argNames: ["that", "req"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_create_bolt_12_invoice_request(req, serializer);
          pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 20, port: port_);
        },
        codec: SseCodec(
          decodeSuccessData: sse_decode_create_bolt_12_invoice_response,
          decodeErrorData: sse_decode_payment_error,
        ),
        constMeta: kCrateSdkBreezSdkLiquidCreateBolt12InvoiceConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidCreateBolt12InvoiceConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_create_bolt12_invoice", argNames: ["that", "req"]);
  ...
  Future<void> crateSdkBreezSdkLiquidDisconnect({required BreezSdkLiquid that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(decodeSuccessData: sse_decode_unit, decodeErrorData: sse_decode_sdk_error),
        constMeta: kCrateSdkBreezSdkLiquidDisconnectConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidDisconnectConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_disconnect", argNames: ["that"]);
  ...
  void crateSdkBreezSdkLiquidEmptyWalletCache({required BreezSdkLiquid that}) {
    return handler.executeSync(
      SyncTask(
        ...
        codec: SseCodec(decodeSuccessData: sse_decode_unit, decodeErrorData: sse_decode_sdk_error),
        constMeta: kCrateSdkBreezSdkLiquidEmptyWalletCacheConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidEmptyWalletCacheConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_empty_wallet_cache", argNames: ["that"]);
  ...
  Future<List<Rate>> crateSdkBreezSdkLiquidFetchFiatRates({required BreezSdkLiquid that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(decodeSuccessData: sse_decode_list_rate, decodeErrorData: sse_decode_sdk_error),
        constMeta: kCrateSdkBreezSdkLiquidFetchFiatRatesConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidFetchFiatRatesConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_fetch_fiat_rates", argNames: ["that"]);
  ...
  Future<LightningPaymentLimitsResponse> crateSdkBreezSdkLiquidFetchLightningLimits({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_lightning_payment_limits_response,
          decodeErrorData: sse_decode_payment_error,
        ),
        constMeta: kCrateSdkBreezSdkLiquidFetchLightningLimitsConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidFetchLightningLimitsConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_fetch_lightning_limits", argNames: ["that"]);
  ...
  Future<OnchainPaymentLimitsResponse> crateSdkBreezSdkLiquidFetchOnchainLimits({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_onchain_payment_limits_response,
          decodeErrorData: sse_decode_payment_error,
        ),
        constMeta: kCrateSdkBreezSdkLiquidFetchOnchainLimitsConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidFetchOnchainLimitsConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_fetch_onchain_limits", argNames: ["that"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_fetch_payment_proposed_fees_request(req, serializer);
          pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 26, port: port_);
        },
        codec: SseCodec(
          decodeSuccessData: sse_decode_fetch_payment_proposed_fees_response,
          decodeErrorData: sse_decode_sdk_error,
        ),
        constMeta: kCrateSdkBreezSdkLiquidFetchPaymentProposedFeesConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidFetchPaymentProposedFeesConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_fetch_payment_proposed_fees", argNames: ["that", "req"]);
  ...
  Future<GetInfoResponse> crateSdkBreezSdkLiquidGetInfo({required BreezSdkLiquid that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateSdkBreezSdkLiquidGetInfoConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidGetInfoConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_get_info", argNames: ["that"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_get_payment_request(req, serializer);
        ...
        constMeta: kCrateSdkBreezSdkLiquidGetPaymentConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidGetPaymentConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_get_payment", argNames: ["that", "req"]);
  ...
  Future<List<FiatCurrency>> crateSdkBreezSdkLiquidListFiatCurrencies({required BreezSdkLiquid that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateSdkBreezSdkLiquidListFiatCurrenciesConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidListFiatCurrenciesConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_list_fiat_currencies", argNames: ["that"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_list_payments_request(req, serializer);
          pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 30, port: port_);
        },
        codec: SseCodec(
          decodeSuccessData: sse_decode_list_payment,
          decodeErrorData: sse_decode_payment_error,
        ),
        constMeta: kCrateSdkBreezSdkLiquidListPaymentsConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidListPaymentsConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_list_payments", argNames: ["that", "req"]);
  ...
  Future<List<RefundableSwap>> crateSdkBreezSdkLiquidListRefundables({required BreezSdkLiquid that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_list_refundable_swap,
          decodeErrorData: sse_decode_sdk_error,
        ),
        constMeta: kCrateSdkBreezSdkLiquidListRefundablesConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidListRefundablesConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_list_refundables", argNames: ["that"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_ln_url_auth_request_data(reqData, serializer);
          pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 32, port: port_);
        },
        codec: SseCodec(
          decodeSuccessData: sse_decode_ln_url_callback_status,
          decodeErrorData: sse_decode_ln_url_auth_error,
        ),
        constMeta: kCrateSdkBreezSdkLiquidLnurlAuthConstMeta,
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidLnurlAuthConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_lnurl_auth", argNames: ["that", "reqData"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_ln_url_pay_request(req, serializer);
          pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 33, port: port_);
        },
        codec: SseCodec(
          decodeSuccessData: sse_decode_ln_url_pay_result,
          decodeErrorData: sse_decode_ln_url_pay_error,
        ),
        constMeta: kCrateSdkBreezSdkLiquidLnurlPayConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidLnurlPayConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_lnurl_pay", argNames: ["that", "req"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_ln_url_withdraw_request(req, serializer);
          pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 34, port: port_);
        },
        codec: SseCodec(
          decodeSuccessData: sse_decode_ln_url_withdraw_result,
          decodeErrorData: sse_decode_ln_url_withdraw_error,
        ),
        constMeta: kCrateSdkBreezSdkLiquidLnurlWithdrawConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidLnurlWithdrawConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_lnurl_withdraw", argNames: ["that", "req"]);
  ...
  Future<InputType> crateSdkBreezSdkLiquidParse({required BreezSdkLiquid that, required String input}) {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(decodeSuccessData: sse_decode_input_type, decodeErrorData: sse_decode_payment_error),
        constMeta: kCrateSdkBreezSdkLiquidParseConstMeta,
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidParseConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_parse", argNames: ["that", "input"]);
  ...
  Future<SendPaymentResponse> crateSdkBreezSdkLiquidPayOnchain({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateSdkBreezSdkLiquidPayOnchainConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidPayOnchainConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_pay_onchain", argNames: ["that", "req"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_prepare_buy_bitcoin_request(req, serializer);
          pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 37, port: port_);
        },
        codec: SseCodec(
          decodeSuccessData: sse_decode_prepare_buy_bitcoin_response,
          decodeErrorData: sse_decode_payment_error,
        ),
        constMeta: kCrateSdkBreezSdkLiquidPrepareBuyBitcoinConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidPrepareBuyBitcoinConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_prepare_buy_bitcoin", argNames: ["that", "req"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_prepare_ln_url_pay_request(req, serializer);
          pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 38, port: port_);
        },
        codec: SseCodec(
          decodeSuccessData: sse_decode_prepare_ln_url_pay_response,
          decodeErrorData: sse_decode_ln_url_pay_error,
        ),
        constMeta: kCrateSdkBreezSdkLiquidPrepareLnurlPayConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidPrepareLnurlPayConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_prepare_lnurl_pay", argNames: ["that", "req"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_prepare_pay_onchain_request(req, serializer);
          pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 39, port: port_);
        },
        codec: SseCodec(
          decodeSuccessData: sse_decode_prepare_pay_onchain_response,
          decodeErrorData: sse_decode_payment_error,
        ),
        constMeta: kCrateSdkBreezSdkLiquidPreparePayOnchainConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidPreparePayOnchainConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_prepare_pay_onchain", argNames: ["that", "req"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_prepare_receive_request(req, serializer);
          pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 40, port: port_);
        },
        codec: SseCodec(
          decodeSuccessData: sse_decode_prepare_receive_response,
          decodeErrorData: sse_decode_payment_error,
        ),
        constMeta: kCrateSdkBreezSdkLiquidPrepareReceivePaymentConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidPrepareReceivePaymentConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_prepare_receive_payment", argNames: ["that", "req"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_prepare_refund_request(req, serializer);
          pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 41, port: port_);
        },
        codec: SseCodec(
          decodeSuccessData: sse_decode_prepare_refund_response,
          decodeErrorData: sse_decode_sdk_error,
        ),
        constMeta: kCrateSdkBreezSdkLiquidPrepareRefundConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidPrepareRefundConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_prepare_refund", argNames: ["that", "req"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_prepare_send_request(req, serializer);
          pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 42, port: port_);
        },
        codec: SseCodec(
          decodeSuccessData: sse_decode_prepare_send_response,
          decodeErrorData: sse_decode_payment_error,
        ),
        constMeta: kCrateSdkBreezSdkLiquidPrepareSendPaymentConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidPrepareSendPaymentConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_prepare_send_payment", argNames: ["that", "req"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_receive_payment_request(req, serializer);
        ...
        constMeta: kCrateSdkBreezSdkLiquidReceivePaymentConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidReceivePaymentConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_receive_payment", argNames: ["that", "req"]);
  ...
  Future<RecommendedFees> crateSdkBreezSdkLiquidRecommendedFees({required BreezSdkLiquid that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateSdkBreezSdkLiquidRecommendedFeesConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidRecommendedFeesConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_recommended_fees", argNames: ["that"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_refund_request(req, serializer);
          pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 45, port: port_);
        },
        codec: SseCodec(
          decodeSuccessData: sse_decode_refund_response,
          decodeErrorData: sse_decode_payment_error,
        ),
        constMeta: kCrateSdkBreezSdkLiquidRefundConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidRefundConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_refund", argNames: ["that", "req"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_String(webhookUrl, serializer);
          pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 46, port: port_);
        },
        codec: SseCodec(decodeSuccessData: sse_decode_unit, decodeErrorData: sse_decode_sdk_error),
        constMeta: kCrateSdkBreezSdkLiquidRegisterWebhookConstMeta,
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidRegisterWebhookConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_register_webhook", argNames: ["that", "webhookUrl"]);
  ...
  Future<void> crateSdkBreezSdkLiquidRescanOnchainSwaps({required BreezSdkLiquid that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(decodeSuccessData: sse_decode_unit, decodeErrorData: sse_decode_sdk_error),
        constMeta: kCrateSdkBreezSdkLiquidRescanOnchainSwapsConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidRescanOnchainSwapsConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_rescan_onchain_swaps", argNames: ["that"]);
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          ...
          sse_encode_box_autoadd_restore_request(req, serializer);
          return pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 48)!;
        },
        codec: SseCodec(decodeSuccessData: sse_decode_unit, decodeErrorData: sse_decode_sdk_error),
        constMeta: kCrateSdkBreezSdkLiquidRestoreConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidRestoreConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_restore", argNames: ["that", "req"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_send_payment_request(req, serializer);
        ...
        constMeta: kCrateSdkBreezSdkLiquidSendPaymentConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidSendPaymentConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_send_payment", argNames: ["that", "req"]);
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          ...
          sse_encode_box_autoadd_sign_message_request(req, serializer);
        ...
        constMeta: kCrateSdkBreezSdkLiquidSignMessageConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidSignMessageConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_sign_message", argNames: ["that", "req"]);
  ...
  Future<void> crateSdkBreezSdkLiquidSync({required BreezSdkLiquid that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(decodeSuccessData: sse_decode_unit, decodeErrorData: sse_decode_sdk_error),
        constMeta: kCrateSdkBreezSdkLiquidSyncConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidSyncConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_sync(dart_style=sync)", argNames: ["that"]);
  ...
  Future<void> crateSdkBreezSdkLiquidUnregisterWebhook({required BreezSdkLiquid that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(decodeSuccessData: sse_decode_unit, decodeErrorData: sse_decode_sdk_error),
        constMeta: kCrateSdkBreezSdkLiquidUnregisterWebhookConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidUnregisterWebhookConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_unregister_webhook", argNames: ["that"]);
  ...
  Future<BreezNwcService> crateSdkBreezSdkLiquidUseNwcPlugin({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateSdkBreezSdkLiquidUseNwcPluginConstMeta,
  ...
  TaskConstMeta get kCrateSdkBreezSdkLiquidUseNwcPluginConstMeta =>
      const TaskConstMeta(debugName: "BreezSdkLiquid_use_nwc_plugin", argNames: ["that", "config"]);
    ...
    unawaited(
      handler.executeNormal(
        NormalTask(
          ...
          codec: SseCodec(decodeSuccessData: sse_decode_String, decodeErrorData: sse_decode_sdk_error),
          constMeta: kCratePluginPluginSdkAddEventListenerConstMeta,
          argValues: [that, listener],
          apiImpl: this,
        ),
      ),
  ...
  TaskConstMeta get kCratePluginPluginSdkAddEventListenerConstMeta =>
      const TaskConstMeta(debugName: "PluginSdk_add_event_listener", argNames: ["that", "listener"]);
  ...
  Future<GetInfoResponse> cratePluginPluginSdkGetInfo({required PluginSdk that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCratePluginPluginSdkGetInfoConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCratePluginPluginSdkGetInfoConstMeta =>
      const TaskConstMeta(debugName: "PluginSdk_get_info", argNames: ["that"]);
  ...
  Future<List<Payment>> cratePluginPluginSdkListPayments({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCratePluginPluginSdkListPaymentsConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCratePluginPluginSdkListPaymentsConstMeta =>
      const TaskConstMeta(debugName: "PluginSdk_list_payments", argNames: ["that", "req"]);
  ...
  Future<InputType> cratePluginPluginSdkParse({required PluginSdk that, required String input}) {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(decodeSuccessData: sse_decode_input_type, decodeErrorData: sse_decode_payment_error),
        constMeta: kCratePluginPluginSdkParseConstMeta,
        argValues: [that, input],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCratePluginPluginSdkParseConstMeta =>
      const TaskConstMeta(debugName: "PluginSdk_parse", argNames: ["that", "input"]);
  ...
  Future<PrepareReceiveResponse> cratePluginPluginSdkPrepareReceivePayment({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCratePluginPluginSdkPrepareReceivePaymentConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCratePluginPluginSdkPrepareReceivePaymentConstMeta =>
      const TaskConstMeta(debugName: "PluginSdk_prepare_receive_payment", argNames: ["that", "req"]);
  ...
  Future<PrepareSendResponse> cratePluginPluginSdkPrepareSendPayment({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCratePluginPluginSdkPrepareSendPaymentConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCratePluginPluginSdkPrepareSendPaymentConstMeta =>
      const TaskConstMeta(debugName: "PluginSdk_prepare_send_payment", argNames: ["that", "req"]);
  ...
  Future<ReceivePaymentResponse> cratePluginPluginSdkReceivePayment({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCratePluginPluginSdkReceivePaymentConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCratePluginPluginSdkReceivePaymentConstMeta =>
      const TaskConstMeta(debugName: "PluginSdk_receive_payment", argNames: ["that", "req"]);
  ...
  Future<SendPaymentResponse> cratePluginPluginSdkSendPayment({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCratePluginPluginSdkSendPaymentConstMeta,
        argValues: [that, req],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCratePluginPluginSdkSendPaymentConstMeta =>
  ...
  String? cratePluginPluginStorageGetItem({required PluginStorage that, required String key}) {
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginStorage(
            that,
            serializer,
          );
        ...
        codec: SseCodec(
          ...
          decodeErrorData: sse_decode_plugin_storage_error,
        ),
        constMeta: kCratePluginPluginStorageGetItemConstMeta,
        argValues: [that, key],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCratePluginPluginStorageGetItemConstMeta =>
      const TaskConstMeta(debugName: "PluginStorage_get_item", argNames: ["that", "key"]);
  ...
  TaskConstMeta get kCratePluginPluginStorageRemoveItemConstMeta =>
      const TaskConstMeta(debugName: "PluginStorage_remove_item", argNames: ["that", "key"]);
  ...
  void cratePluginPluginStorageSetItem({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        argValues: [that, key, value, oldValue],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCratePluginPluginStorageSetItemConstMeta => const TaskConstMeta(
    debugName: "PluginStorage_set_item",
    argNames: ["that", "key", "value", "oldValue"],
  );
  ...
  TaskConstMeta get kCrateEventsBreezEventListenerOnEventConstMeta =>
      const TaskConstMeta(debugName: "breez_event_listener_on_event", argNames: ["that", "e"]);
  ...
  TaskConstMeta get kCrateLoggerBreezLogStreamConstMeta =>
  ...
  TaskConstMeta get kCrateNwcEventBreezNwcEventListenerOnEventConstMeta =>
      const TaskConstMeta(debugName: "breez_nwc_event_listener_on_event", argNames: ["that", "e"]);
  ...
  Future<BreezSdkLiquid> crateSdkConnect({required ConnectRequest req}) {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData:
              sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezSdkLiquid,
          decodeErrorData: sse_decode_sdk_error,
        ),
  ...
  TaskConstMeta get kCrateSdkConnectConstMeta => const TaskConstMeta(debugName: "connect", argNames: ["req"]);
  ...
  TaskConstMeta get kCrateSdkParseInvoiceConstMeta =>
      const TaskConstMeta(debugName: "parse_invoice", argNames: ["input"]);

  RustArcIncrementStrongCountFnType get rust_arc_increment_strong_count_BreezNwcService => wire
      .rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezNwcService;

  RustArcDecrementStrongCountFnType get rust_arc_decrement_strong_count_BreezNwcService => wire
      .rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezNwcService;

  RustArcIncrementStrongCountFnType get rust_arc_increment_strong_count_BreezSdkLiquid => wire
      .rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezSdkLiquid;

  RustArcDecrementStrongCountFnType get rust_arc_decrement_strong_count_BreezSdkLiquid => wire
      .rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezSdkLiquid;

  RustArcIncrementStrongCountFnType get rust_arc_increment_strong_count_PluginSdk => wire
      .rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginSdk;

  RustArcDecrementStrongCountFnType get rust_arc_decrement_strong_count_PluginSdk => wire
      .rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginSdk;

  RustArcIncrementStrongCountFnType get rust_arc_increment_strong_count_PluginStorage => wire
      .rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginStorage;

  RustArcDecrementStrongCountFnType get rust_arc_decrement_strong_count_PluginStorage => wire
      .rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginStorage;
  ...
  @protected
  BreezNwcService
  dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezNwcService(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BreezNwcServiceImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }

  @protected
  BreezSdkLiquid
  dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezSdkLiquid(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BreezSdkLiquidImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }

  @protected
  PluginSdk dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginSdk(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return PluginSdkImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }

  @protected
  PluginStorage
  dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginStorage(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return PluginStorageImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }

  @protected
  BreezNwcService
  dco_decode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezNwcService(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BreezNwcServiceImpl.frbInternalDcoDecode(raw as List<dynamic>);
  ...
  @protected
  BreezSdkLiquid
  dco_decode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezSdkLiquid(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BreezSdkLiquidImpl.frbInternalDcoDecode(raw as List<dynamic>);
  ...
  @protected
  PluginSdk dco_decode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginSdk(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return PluginSdkImpl.frbInternalDcoDecode(raw as List<dynamic>);
  ...
  @protected
  PluginStorage
  dco_decode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginStorage(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return PluginStorageImpl.frbInternalDcoDecode(raw as List<dynamic>);
  ...
  @protected
  Map<String, NwcConnection> dco_decode_Map_String_nwc_connection_None(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return Map.fromEntries(
      dco_decode_list_record_string_nwc_connection(raw).map((e) => MapEntry(e.$1, e.$2)),
    );
  }

  @protected
  BreezNwcService dco_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezNwcService(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BreezNwcServiceImpl.frbInternalDcoDecode(raw as List<dynamic>);
  ...
  @protected
  BreezSdkLiquid dco_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezSdkLiquid(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BreezSdkLiquidImpl.frbInternalDcoDecode(raw as List<dynamic>);
  ...
  @protected
  PluginSdk dco_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginSdk(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return PluginSdkImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }

  @protected
  PluginStorage dco_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginStorage(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return PluginStorageImpl.frbInternalDcoDecode(raw as List<dynamic>);
  ...
  @protected
  RustStreamSink<NwcEvent> dco_decode_StreamSink_nwc_event_Sse(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    throw UnimplementedError();
  }
  ...
  @protected
  NwcEventListener dco_decode_TraitDef_NwcEventListener(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    throw UnimplementedError();
  }
  ...
  @protected
  AddConnectionRequest dco_decode_add_connection_request(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 4) throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
    return AddConnectionRequest(
      name: dco_decode_String(arr[0]),
      receiveOnly: dco_decode_opt_box_autoadd_bool(arr[1]),
      expiryTimeMins: dco_decode_opt_box_autoadd_u_32(arr[2]),
      periodicBudgetReq: dco_decode_opt_box_autoadd_periodic_budget_request(arr[3]),
    );
  }

  @protected
  AddConnectionResponse dco_decode_add_connection_response(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return AddConnectionResponse(connection: dco_decode_nwc_connection(arr[0]));
  }
  ...
  @protected
  AddConnectionRequest dco_decode_box_autoadd_add_connection_request(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_add_connection_request(raw);
  }
  ...
  @protected
  BreezEventListener dco_decode_box_autoadd_breez_event_listener(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_breez_event_listener(raw);
  }

  @protected
  BreezNwcEventListener dco_decode_box_autoadd_breez_nwc_event_listener(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_breez_nwc_event_listener(raw);
  }
  ...
  @protected
  DescriptionHash dco_decode_box_autoadd_description_hash(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_description_hash(raw);
  }

  @protected
  EditConnectionRequest dco_decode_box_autoadd_edit_connection_request(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_edit_connection_request(raw);
  }
  ...
  @protected
  NostrServiceInfo dco_decode_box_autoadd_nostr_service_info(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_nostr_service_info(raw);
  }

  @protected
  NostrWalletConnectUri dco_decode_box_autoadd_nostr_wallet_connect_uri(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_nostr_wallet_connect_uri(raw);
  }

  @protected
  NwcConfig dco_decode_box_autoadd_nwc_config(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_nwc_config(raw);
  }
  ...
  @protected
  PeriodicBudget dco_decode_box_autoadd_periodic_budget(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_periodic_budget(raw);
  }

  @protected
  PeriodicBudgetRequest dco_decode_box_autoadd_periodic_budget_request(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_periodic_budget_request(raw);
  }
  ...
  @protected
  BreezEventListener dco_decode_breez_event_listener(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return BreezEventListener(stream: dco_decode_StreamSink_sdk_event_Sse(arr[0]));
  }

  @protected
  BreezNwcEventListener dco_decode_breez_nwc_event_listener(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return BreezNwcEventListener(stream: dco_decode_StreamSink_nwc_event_Sse(arr[0]));
  }
  ...
  @protected
  DescriptionHash dco_decode_description_hash(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    switch (raw[0]) {
      case 0:
        return DescriptionHash_UseDescription();
      case 1:
        return DescriptionHash_Custom(hash: dco_decode_String(raw[1]));
      default:
        throw Exception("unreachable");
    }
  }
  ...
  @protected
  EditConnectionRequest dco_decode_edit_connection_request(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    ...
    return EditConnectionRequest(
      ...
      receiveOnly: dco_decode_opt_box_autoadd_bool(arr[1]),
      expiryTimeMins: dco_decode_opt_box_autoadd_u_32(arr[2]),
      removeExpiry: dco_decode_opt_box_autoadd_bool(arr[3]),
      periodicBudgetReq: dco_decode_opt_box_autoadd_periodic_budget_request(arr[4]),
      removePeriodicBudget: dco_decode_opt_box_autoadd_bool(arr[5]),
    );
  }

  @protected
  EditConnectionResponse dco_decode_edit_connection_response(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return EditConnectionResponse(connection: dco_decode_nwc_connection(arr[0]));
  }
  ...
  InputType dco_decode_input_type(dynamic raw) {
    ...
    switch (raw[0]) {
      ...
      case 10:
        return InputType_NostrWalletConnectUri(data: dco_decode_box_autoadd_nostr_wallet_connect_uri(raw[1]));
      default:
        throw Exception("unreachable");
    }
  }
  ...
  @protected
  List<(String, NwcConnection)> dco_decode_list_record_string_nwc_connection(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_record_string_nwc_connection).toList();
  }
  ...
  @protected
  NostrServiceInfo dco_decode_nostr_service_info(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return NostrServiceInfo(
      walletPubkey: dco_decode_String(arr[0]),
      connectedRelays: dco_decode_list_String(arr[1]),
    );
  }

  @protected
  NostrWalletConnectUri dco_decode_nostr_wallet_connect_uri(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 5) throw Exception('unexpected arr length: expect 5 but see ${arr.length}');
    return NostrWalletConnectUri(
      walletServicePublicKey: dco_decode_String(arr[0]),
      appPublicKey: dco_decode_String(arr[1]),
      appSecret: dco_decode_String(arr[2]),
  ...
  @protected
  NwcConfig dco_decode_nwc_config(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 3) throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return NwcConfig(
      relayUrls: dco_decode_opt_list_String(arr[0]),
      secretKeyHex: dco_decode_opt_String(arr[1]),
      listenToEvents: dco_decode_opt_box_autoadd_bool(arr[2]),
    );
  }

  @protected
  NwcConnection dco_decode_nwc_connection(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 6) throw Exception('unexpected arr length: expect 6 but see ${arr.length}');
    return NwcConnection(
      connectionString: dco_decode_String(arr[0]),
      createdAt: dco_decode_u_32(arr[1]),
      receiveOnly: dco_decode_bool(arr[2]),
      paidAmountSat: dco_decode_u_64(arr[3]),
      expiresAt: dco_decode_opt_box_autoadd_u_32(arr[4]),
      periodicBudget: dco_decode_opt_box_autoadd_periodic_budget(arr[5]),
    );
  }

  @protected
  NwcError dco_decode_nwc_error(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    switch (raw[0]) {
      case 0:
        return NwcError_Persist(err: dco_decode_String(raw[1]));
      case 1:
        return NwcError_Generic(err: dco_decode_String(raw[1]));
      case 2:
        return NwcError_Network(err: dco_decode_String(raw[1]));
      case 3:
        return NwcError_PubkeyNotFound(pubkey: dco_decode_String(raw[1]));
      case 4:
        return NwcError_InvalidSignature(err: dco_decode_String(raw[1]));
      case 5:
        return NwcError_Encryption(err: dco_decode_String(raw[1]));
      case 6:
        return NwcError_EventExpired();
      case 7:
        return NwcError_AlreadyReplied();
      case 8:
        return NwcError_InvoiceExpired();
      case 9:
        return NwcError_InvoiceWithoutAmount();
      case 10:
        return NwcError_MaxBudgetExceeded();
      case 11:
  ...
  NwcEvent dco_decode_nwc_event(dynamic raw) {
    ...
    return NwcEvent(
      ...
      connectionName: dco_decode_opt_String(arr[1]),
      details: dco_decode_nwc_event_details(arr[2]),
    );
  }

  @protected
  NwcEventDetails dco_decode_nwc_event_details(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    switch (raw[0]) {
      case 0:
        return NwcEventDetails_Connected();
      case 1:
        return NwcEventDetails_Disconnected();
      case 2:
        return NwcEventDetails_PayInvoice(
      ...
      case 3:
        return NwcEventDetails_MakeInvoice();
      case 4:
        return NwcEventDetails_ListTransactions();
      case 5:
        return NwcEventDetails_GetBalance();
      case 6:
        return NwcEventDetails_GetInfo();
      case 7:
        return NwcEventDetails_ConnectionExpired();
      case 8:
        return NwcEventDetails_ConnectionRefreshed();
      case 9:
        return NwcEventDetails_ZapReceived(invoice: dco_decode_String(raw[1]));
      default:
        throw Exception("unreachable");
    }
  }
  ...
  @protected
  DescriptionHash? dco_decode_opt_box_autoadd_description_hash(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_description_hash(raw);
  }
  ...
  @protected
  NostrServiceInfo? dco_decode_opt_box_autoadd_nostr_service_info(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_nostr_service_info(raw);
  }
  ...
  @protected
  PeriodicBudget? dco_decode_opt_box_autoadd_periodic_budget(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_periodic_budget(raw);
  }

  @protected
  PeriodicBudgetRequest? dco_decode_opt_box_autoadd_periodic_budget_request(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_periodic_budget_request(raw);
  }
  ...
  @protected
  PeriodicBudget dco_decode_periodic_budget(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 4) throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
    return PeriodicBudget(
      usedBudgetSat: dco_decode_u_64(arr[0]),
      maxBudgetSat: dco_decode_u_64(arr[1]),
      renewsAt: dco_decode_opt_box_autoadd_u_32(arr[2]),
      updatedAt: dco_decode_u_32(arr[3]),
    );
  }

  @protected
  PeriodicBudgetRequest dco_decode_periodic_budget_request(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return PeriodicBudgetRequest(
      maxBudgetSat: dco_decode_u_64(arr[0]),
      renewalTimeMins: dco_decode_opt_box_autoadd_u_32(arr[1]),
    );
  }

  @protected
  PluginStorageError dco_decode_plugin_storage_error(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    switch (raw[0]) {
      case 0:
        return PluginStorageError_DataTooOld();
      case 1:
        return PluginStorageError_Encryption(err: dco_decode_String(raw[1]));
      case 2:
        return PluginStorageError_Generic(err: dco_decode_String(raw[1]));
      default:
        throw Exception("unreachable");
    }
  }
  ...
  PrepareSendRequest dco_decode_prepare_send_request(dynamic raw) {
    ...
    return PrepareSendRequest(
      ...
      paymentTimeoutSec: dco_decode_opt_box_autoadd_u_64(arr[3]),
    );
  }
  ...
  PrepareSendResponse dco_decode_prepare_send_response(dynamic raw) {
    ...
    return PrepareSendResponse(
      ...
      disableMrh: dco_decode_opt_box_autoadd_bool(arr[5]),
      paymentTimeoutSec: dco_decode_opt_box_autoadd_u_64(arr[6]),
    );
  }
  ...
  ReceivePaymentRequest dco_decode_receive_payment_request(dynamic raw) {
    ...
    return ReceivePaymentRequest(
      ...
      descriptionHash: dco_decode_opt_box_autoadd_description_hash(arr[2]),
  ...
  @protected
  (String, NwcConnection) dco_decode_record_string_nwc_connection(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 2) {
      throw Exception('Expected 2 elements, got ${arr.length}');
    }
    return (dco_decode_String(arr[0]), dco_decode_nwc_connection(arr[1]));
  }
  ...
  SdkError dco_decode_sdk_error(dynamic raw) {
    ...
    switch (raw[0]) {
      ...
      case 2:
        return SdkError_NetworkNotSupported(network: dco_decode_String(raw[1]));
      case 3:
  ...
  sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezNwcService(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return BreezNwcServiceImpl.frbInternalSseDecode(
  ...
  sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezSdkLiquid(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return BreezSdkLiquidImpl.frbInternalSseDecode(
      sse_decode_usize(deserializer),
      sse_decode_i_32(deserializer),
    );
  }
  ...
  @protected
  PluginSdk sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginSdk(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return PluginSdkImpl.frbInternalSseDecode(sse_decode_usize(deserializer), sse_decode_i_32(deserializer));
  }

  @protected
  PluginStorage
  sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginStorage(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return PluginStorageImpl.frbInternalSseDecode(
      sse_decode_usize(deserializer),
      sse_decode_i_32(deserializer),
    );
  }
  ...
  @protected
  BreezNwcService
  sse_decode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezNwcService(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return BreezNwcServiceImpl.frbInternalSseDecode(
  ...
  @protected
  BreezSdkLiquid
  sse_decode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezSdkLiquid(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return BreezSdkLiquidImpl.frbInternalSseDecode(
  ...
  @protected
  PluginSdk sse_decode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginSdk(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return PluginSdkImpl.frbInternalSseDecode(sse_decode_usize(deserializer), sse_decode_i_32(deserializer));
  ...
  @protected
  PluginStorage
  sse_decode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginStorage(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return PluginStorageImpl.frbInternalSseDecode(
  ...
  @protected
  Map<String, NwcConnection> sse_decode_Map_String_nwc_connection_None(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_list_record_string_nwc_connection(deserializer);
    return Map.fromEntries(inner.map((e) => MapEntry(e.$1, e.$2)));
  }

  @protected
  BreezNwcService sse_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezNwcService(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return BreezNwcServiceImpl.frbInternalSseDecode(
  ...
  @protected
  BreezSdkLiquid sse_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezSdkLiquid(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return BreezSdkLiquidImpl.frbInternalSseDecode(
  ...
  @protected
  PluginSdk sse_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginSdk(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return PluginSdkImpl.frbInternalSseDecode(sse_decode_usize(deserializer), sse_decode_i_32(deserializer));
  ...
  @protected
  PluginStorage sse_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginStorage(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return PluginStorageImpl.frbInternalSseDecode(
  ...
  @protected
  RustStreamSink<NwcEvent> sse_decode_StreamSink_nwc_event_Sse(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    throw UnimplementedError('Unreachable ()');
  }
  ...
  @protected
  AddConnectionRequest sse_decode_add_connection_request(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_name = sse_decode_String(deserializer);
    var var_receiveOnly = sse_decode_opt_box_autoadd_bool(deserializer);
    var var_expiryTimeMins = sse_decode_opt_box_autoadd_u_32(deserializer);
    var var_periodicBudgetReq = sse_decode_opt_box_autoadd_periodic_budget_request(deserializer);
    return AddConnectionRequest(
      name: var_name,
      receiveOnly: var_receiveOnly,
      expiryTimeMins: var_expiryTimeMins,
      periodicBudgetReq: var_periodicBudgetReq,
    );
  }

  @protected
  AddConnectionResponse sse_decode_add_connection_response(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_connection = sse_decode_nwc_connection(deserializer);
    return AddConnectionResponse(connection: var_connection);
  }
  ...
  @protected
  AddConnectionRequest sse_decode_box_autoadd_add_connection_request(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_add_connection_request(deserializer));
  }
  ...
  @protected
  BreezEventListener sse_decode_box_autoadd_breez_event_listener(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_breez_event_listener(deserializer));
  }

  @protected
  BreezNwcEventListener sse_decode_box_autoadd_breez_nwc_event_listener(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_breez_nwc_event_listener(deserializer));
  }
  ...
  @protected
  DescriptionHash sse_decode_box_autoadd_description_hash(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_description_hash(deserializer));
  }

  @protected
  EditConnectionRequest sse_decode_box_autoadd_edit_connection_request(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_edit_connection_request(deserializer));
  }
  ...
  @protected
  NostrServiceInfo sse_decode_box_autoadd_nostr_service_info(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_nostr_service_info(deserializer));
  }

  @protected
  NostrWalletConnectUri sse_decode_box_autoadd_nostr_wallet_connect_uri(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_nostr_wallet_connect_uri(deserializer));
  }

  @protected
  NwcConfig sse_decode_box_autoadd_nwc_config(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_nwc_config(deserializer));
  }
  ...
  @protected
  PeriodicBudget sse_decode_box_autoadd_periodic_budget(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_periodic_budget(deserializer));
  }

  @protected
  PeriodicBudgetRequest sse_decode_box_autoadd_periodic_budget_request(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_periodic_budget_request(deserializer));
  }
  ...
  @protected
  BreezEventListener sse_decode_breez_event_listener(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_stream = sse_decode_StreamSink_sdk_event_Sse(deserializer);
    return BreezEventListener(stream: var_stream);
  }

  @protected
  BreezNwcEventListener sse_decode_breez_nwc_event_listener(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_stream = sse_decode_StreamSink_nwc_event_Sse(deserializer);
    return BreezNwcEventListener(stream: var_stream);
  }
  ...
  @protected
  DescriptionHash sse_decode_description_hash(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    switch (tag_) {
      ...
      case 1:
        ...
        return DescriptionHash_Custom(hash: var_hash);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  @protected
  EditConnectionRequest sse_decode_edit_connection_request(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_name = sse_decode_String(deserializer);
    var var_receiveOnly = sse_decode_opt_box_autoadd_bool(deserializer);
    var var_expiryTimeMins = sse_decode_opt_box_autoadd_u_32(deserializer);
    var var_removeExpiry = sse_decode_opt_box_autoadd_bool(deserializer);
    var var_periodicBudgetReq = sse_decode_opt_box_autoadd_periodic_budget_request(deserializer);
    var var_removePeriodicBudget = sse_decode_opt_box_autoadd_bool(deserializer);
    return EditConnectionRequest(
      name: var_name,
      receiveOnly: var_receiveOnly,
      expiryTimeMins: var_expiryTimeMins,
      removeExpiry: var_removeExpiry,
      periodicBudgetReq: var_periodicBudgetReq,
      removePeriodicBudget: var_removePeriodicBudget,
    );
  }

  @protected
  EditConnectionResponse sse_decode_edit_connection_response(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_connection = sse_decode_nwc_connection(deserializer);
    return EditConnectionResponse(connection: var_connection);
  }
  ...
  InputType sse_decode_input_type(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      ...
      case 10:
        var var_data = sse_decode_box_autoadd_nostr_wallet_connect_uri(deserializer);
        return InputType_NostrWalletConnectUri(data: var_data);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  @protected
  List<(String, NwcConnection)> sse_decode_list_record_string_nwc_connection(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <(String, NwcConnection)>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_record_string_nwc_connection(deserializer));
    }
    return ans_;
  }
  ...
  @protected
  NostrServiceInfo sse_decode_nostr_service_info(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_walletPubkey = sse_decode_String(deserializer);
    var var_connectedRelays = sse_decode_list_String(deserializer);
    return NostrServiceInfo(walletPubkey: var_walletPubkey, connectedRelays: var_connectedRelays);
  }

  @protected
  NostrWalletConnectUri sse_decode_nostr_wallet_connect_uri(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_walletServicePublicKey = sse_decode_String(deserializer);
    var var_appPublicKey = sse_decode_String(deserializer);
    ...
    return NostrWalletConnectUri(
      walletServicePublicKey: var_walletServicePublicKey,
      appPublicKey: var_appPublicKey,
  ...
  @protected
  NwcConfig sse_decode_nwc_config(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_relayUrls = sse_decode_opt_list_String(deserializer);
    var var_secretKeyHex = sse_decode_opt_String(deserializer);
    var var_listenToEvents = sse_decode_opt_box_autoadd_bool(deserializer);
    return NwcConfig(
      relayUrls: var_relayUrls,
      secretKeyHex: var_secretKeyHex,
      listenToEvents: var_listenToEvents,
    );
  }

  @protected
  NwcConnection sse_decode_nwc_connection(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_connectionString = sse_decode_String(deserializer);
    var var_createdAt = sse_decode_u_32(deserializer);
    var var_receiveOnly = sse_decode_bool(deserializer);
    var var_paidAmountSat = sse_decode_u_64(deserializer);
    var var_expiresAt = sse_decode_opt_box_autoadd_u_32(deserializer);
    var var_periodicBudget = sse_decode_opt_box_autoadd_periodic_budget(deserializer);
    return NwcConnection(
      connectionString: var_connectionString,
      createdAt: var_createdAt,
      receiveOnly: var_receiveOnly,
      paidAmountSat: var_paidAmountSat,
      expiresAt: var_expiresAt,
      periodicBudget: var_periodicBudget,
    );
  }

  @protected
  NwcError sse_decode_nwc_error(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    switch (tag_) {
      case 0:
        var var_err = sse_decode_String(deserializer);
        return NwcError_Persist(err: var_err);
      case 1:
        var var_err = sse_decode_String(deserializer);
        return NwcError_Generic(err: var_err);
      case 2:
        var var_err = sse_decode_String(deserializer);
        return NwcError_Network(err: var_err);
      case 3:
        var var_pubkey = sse_decode_String(deserializer);
        return NwcError_PubkeyNotFound(pubkey: var_pubkey);
      case 4:
        var var_err = sse_decode_String(deserializer);
        return NwcError_InvalidSignature(err: var_err);
      case 5:
        var var_err = sse_decode_String(deserializer);
        return NwcError_Encryption(err: var_err);
      case 6:
        return NwcError_EventExpired();
      case 7:
        return NwcError_AlreadyReplied();
  ...
  NwcEvent sse_decode_nwc_event(SseDeserializer deserializer) {
    ...
    var var_connectionName = sse_decode_opt_String(deserializer);
    var var_details = sse_decode_nwc_event_details(deserializer);
    return NwcEvent(eventId: var_eventId, connectionName: var_connectionName, details: var_details);
  }

  @protected
  NwcEventDetails sse_decode_nwc_event_details(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    switch (tag_) {
      ...
      case 9:
        var var_invoice = sse_decode_String(deserializer);
        return NwcEventDetails_ZapReceived(invoice: var_invoice);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  @protected
  DescriptionHash? sse_decode_opt_box_autoadd_description_hash(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_description_hash(deserializer));
    } else {
      return null;
    }
  }
  ...
  @protected
  NostrServiceInfo? sse_decode_opt_box_autoadd_nostr_service_info(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_nostr_service_info(deserializer));
    } else {
      return null;
    }
  }
  ...
  @protected
  PeriodicBudget? sse_decode_opt_box_autoadd_periodic_budget(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_periodic_budget(deserializer));
    } else {
      return null;
    }
  }
  ...
  @protected
  PeriodicBudgetRequest? sse_decode_opt_box_autoadd_periodic_budget_request(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_periodic_budget_request(deserializer));
    } else {
      return null;
    }
  }
  ...
  @protected
  PeriodicBudget sse_decode_periodic_budget(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_usedBudgetSat = sse_decode_u_64(deserializer);
    var var_maxBudgetSat = sse_decode_u_64(deserializer);
    var var_renewsAt = sse_decode_opt_box_autoadd_u_32(deserializer);
    var var_updatedAt = sse_decode_u_32(deserializer);
    return PeriodicBudget(
      usedBudgetSat: var_usedBudgetSat,
      maxBudgetSat: var_maxBudgetSat,
      renewsAt: var_renewsAt,
      updatedAt: var_updatedAt,
    );
  }

  @protected
  PeriodicBudgetRequest sse_decode_periodic_budget_request(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_maxBudgetSat = sse_decode_u_64(deserializer);
    var var_renewalTimeMins = sse_decode_opt_box_autoadd_u_32(deserializer);
    return PeriodicBudgetRequest(maxBudgetSat: var_maxBudgetSat, renewalTimeMins: var_renewalTimeMins);
  }

  @protected
  PluginStorageError sse_decode_plugin_storage_error(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    switch (tag_) {
      ...
      case 1:
        var var_err = sse_decode_String(deserializer);
        return PluginStorageError_Encryption(err: var_err);
      case 2:
        var var_err = sse_decode_String(deserializer);
        return PluginStorageError_Generic(err: var_err);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  PrepareSendRequest sse_decode_prepare_send_request(SseDeserializer deserializer) {
    ...
    var var_paymentTimeoutSec = sse_decode_opt_box_autoadd_u_64(deserializer);
    return PrepareSendRequest(
      destination: var_destination,
      amount: var_amount,
  ...
  ReceivePaymentRequest sse_decode_receive_payment_request(SseDeserializer deserializer) {
    ...
    var var_description = sse_decode_opt_String(deserializer);
    var var_descriptionHash = sse_decode_opt_box_autoadd_description_hash(deserializer);
    var var_payerNote = sse_decode_opt_String(deserializer);
    return ReceivePaymentRequest(
  ...
  @protected
  (String, NwcConnection) sse_decode_record_string_nwc_connection(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_field0 = sse_decode_String(deserializer);
    var var_field1 = sse_decode_nwc_connection(deserializer);
  ...
  SdkError sse_decode_sdk_error(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      ...
      case 2:
        ...
        return SdkError_NetworkNotSupported(network: var_network);
      case 3:
        return SdkError_NotStarted();
      case 4:
        var var_err = sse_decode_String(deserializer);
  ...
  @protected
  void sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezNwcService(
    BreezNwcService self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize((self as BreezNwcServiceImpl).frbInternalSseEncode(move: true), serializer);
  }

  @protected
  void sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezSdkLiquid(
    BreezSdkLiquid self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize((self as BreezSdkLiquidImpl).frbInternalSseEncode(move: true), serializer);
  }

  @protected
  void sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginSdk(
    PluginSdk self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize((self as PluginSdkImpl).frbInternalSseEncode(move: true), serializer);
  }

  @protected
  void sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginStorage(
    PluginStorage self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize((self as PluginStorageImpl).frbInternalSseEncode(move: true), serializer);
  }

  @protected
  void sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezNwcService(
    BreezNwcService self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize((self as BreezNwcServiceImpl).frbInternalSseEncode(move: false), serializer);
  }

  @protected
  void sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezSdkLiquid(
    BreezSdkLiquid self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize((self as BreezSdkLiquidImpl).frbInternalSseEncode(move: false), serializer);
  }

  @protected
  void sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginSdk(
    PluginSdk self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize((self as PluginSdkImpl).frbInternalSseEncode(move: false), serializer);
  }

  @protected
  void sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginStorage(
    PluginStorage self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize((self as PluginStorageImpl).frbInternalSseEncode(move: false), serializer);
  }

  @protected
  void sse_encode_Map_String_nwc_connection_None(Map<String, NwcConnection> self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_record_string_nwc_connection(
  ...
  @protected
  void sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezNwcService(
    BreezNwcService self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize((self as BreezNwcServiceImpl).frbInternalSseEncode(move: null), serializer);
  }

  @protected
  void sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBreezSdkLiquid(
    BreezSdkLiquid self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize((self as BreezSdkLiquidImpl).frbInternalSseEncode(move: null), serializer);
  }

  @protected
  void sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginSdk(
    PluginSdk self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize((self as PluginSdkImpl).frbInternalSseEncode(move: null), serializer);
  }

  @protected
  void sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerPluginStorage(
    PluginStorage self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize((self as PluginStorageImpl).frbInternalSseEncode(move: null), serializer);
  }
  ...
  @protected
  void sse_encode_StreamSink_nwc_event_Sse(RustStreamSink<NwcEvent> self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(
      self.setupAndSerialize(
        codec: SseCodec(decodeSuccessData: sse_decode_nwc_event, decodeErrorData: sse_decode_AnyhowException),
      ),
      serializer,
    );
  }
  ...
  @protected
  void sse_encode_add_connection_request(AddConnectionRequest self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.name, serializer);
    sse_encode_opt_box_autoadd_bool(self.receiveOnly, serializer);
    sse_encode_opt_box_autoadd_u_32(self.expiryTimeMins, serializer);
    sse_encode_opt_box_autoadd_periodic_budget_request(self.periodicBudgetReq, serializer);
  }

  @protected
  void sse_encode_add_connection_response(AddConnectionResponse self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_nwc_connection(self.connection, serializer);
  }
  ...
  @protected
  void sse_encode_box_autoadd_add_connection_request(AddConnectionRequest self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_add_connection_request(self, serializer);
  }
  ...
  @protected
  void sse_encode_box_autoadd_breez_event_listener(BreezEventListener self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_breez_event_listener(self, serializer);
  }

  @protected
  void sse_encode_box_autoadd_breez_nwc_event_listener(BreezNwcEventListener self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_breez_nwc_event_listener(self, serializer);
  }
  ...
  @protected
  void sse_encode_box_autoadd_description_hash(DescriptionHash self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_description_hash(self, serializer);
  }

  @protected
  void sse_encode_box_autoadd_edit_connection_request(EditConnectionRequest self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_edit_connection_request(self, serializer);
  }
  ...
  @protected
  void sse_encode_box_autoadd_nostr_service_info(NostrServiceInfo self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_nostr_service_info(self, serializer);
  }

  @protected
  void sse_encode_box_autoadd_nostr_wallet_connect_uri(NostrWalletConnectUri self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_nostr_wallet_connect_uri(self, serializer);
  }

  @protected
  void sse_encode_box_autoadd_nwc_config(NwcConfig self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_nwc_config(self, serializer);
  }
  ...
  @protected
  void sse_encode_box_autoadd_periodic_budget(PeriodicBudget self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_periodic_budget(self, serializer);
  }

  @protected
  void sse_encode_box_autoadd_periodic_budget_request(PeriodicBudgetRequest self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_periodic_budget_request(self, serializer);
  }
  ...
  @protected
  void sse_encode_breez_event_listener(BreezEventListener self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_StreamSink_sdk_event_Sse(self.stream, serializer);
  }

  @protected
  void sse_encode_breez_nwc_event_listener(BreezNwcEventListener self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_StreamSink_nwc_event_Sse(self.stream, serializer);
  }
  ...
  @protected
  void sse_encode_description_hash(DescriptionHash self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case DescriptionHash_UseDescription():
        sse_encode_i_32(0, serializer);
      case DescriptionHash_Custom(hash: final hash):
        sse_encode_i_32(1, serializer);
  ...
  @protected
  void sse_encode_edit_connection_request(EditConnectionRequest self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.name, serializer);
    sse_encode_opt_box_autoadd_bool(self.receiveOnly, serializer);
    sse_encode_opt_box_autoadd_u_32(self.expiryTimeMins, serializer);
    sse_encode_opt_box_autoadd_bool(self.removeExpiry, serializer);
    sse_encode_opt_box_autoadd_periodic_budget_request(self.periodicBudgetReq, serializer);
    sse_encode_opt_box_autoadd_bool(self.removePeriodicBudget, serializer);
  }

  @protected
  void sse_encode_edit_connection_response(EditConnectionResponse self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_nwc_connection(self.connection, serializer);
  }
  ...
  void sse_encode_input_type(InputType self, SseSerializer serializer) {
    ...
    switch (self) {
      ...
      case InputType_NostrWalletConnectUri(data: final data):
        sse_encode_i_32(10, serializer);
        sse_encode_box_autoadd_nostr_wallet_connect_uri(data, serializer);
    }
  }
  ...
  @protected
  void sse_encode_list_record_string_nwc_connection(
    List<(String, NwcConnection)> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_record_string_nwc_connection(item, serializer);
    }
  }
  ...
  @protected
  void sse_encode_nostr_service_info(NostrServiceInfo self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.walletPubkey, serializer);
    sse_encode_list_String(self.connectedRelays, serializer);
  }

  @protected
  void sse_encode_nostr_wallet_connect_uri(NostrWalletConnectUri self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.walletServicePublicKey, serializer);
    sse_encode_String(self.appPublicKey, serializer);
  ...
  @protected
  void sse_encode_nwc_config(NwcConfig self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_opt_list_String(self.relayUrls, serializer);
    sse_encode_opt_String(self.secretKeyHex, serializer);
    sse_encode_opt_box_autoadd_bool(self.listenToEvents, serializer);
  }

  @protected
  void sse_encode_nwc_connection(NwcConnection self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.connectionString, serializer);
    sse_encode_u_32(self.createdAt, serializer);
    sse_encode_bool(self.receiveOnly, serializer);
    sse_encode_u_64(self.paidAmountSat, serializer);
    sse_encode_opt_box_autoadd_u_32(self.expiresAt, serializer);
    sse_encode_opt_box_autoadd_periodic_budget(self.periodicBudget, serializer);
  }

  @protected
  void sse_encode_nwc_error(NwcError self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case NwcError_Persist(err: final err):
        sse_encode_i_32(0, serializer);
        sse_encode_String(err, serializer);
      case NwcError_Generic(err: final err):
        sse_encode_i_32(1, serializer);
        sse_encode_String(err, serializer);
      case NwcError_Network(err: final err):
        sse_encode_i_32(2, serializer);
        sse_encode_String(err, serializer);
      case NwcError_PubkeyNotFound(pubkey: final pubkey):
        sse_encode_i_32(3, serializer);
        sse_encode_String(pubkey, serializer);
      case NwcError_InvalidSignature(err: final err):
        sse_encode_i_32(4, serializer);
        sse_encode_String(err, serializer);
      case NwcError_Encryption(err: final err):
        sse_encode_i_32(5, serializer);
        sse_encode_String(err, serializer);
      case NwcError_EventExpired():
        sse_encode_i_32(6, serializer);
      case NwcError_AlreadyReplied():
        sse_encode_i_32(7, serializer);
      case NwcError_InvoiceExpired():
        sse_encode_i_32(8, serializer);
      case NwcError_InvoiceWithoutAmount():
        sse_encode_i_32(9, serializer);
      case NwcError_MaxBudgetExceeded():
        sse_encode_i_32(10, serializer);
      case NwcError_ConnectionNotFound():
        sse_encode_i_32(11, serializer);
  ...
  void sse_encode_nwc_event(NwcEvent self, SseSerializer serializer) {
    ...
    sse_encode_opt_String(self.connectionName, serializer);
    sse_encode_nwc_event_details(self.details, serializer);
  }

  @protected
  void sse_encode_nwc_event_details(NwcEventDetails self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case NwcEventDetails_Connected():
        sse_encode_i_32(0, serializer);
      case NwcEventDetails_Disconnected():
        sse_encode_i_32(1, serializer);
      case NwcEventDetails_PayInvoice(
      ...
      case NwcEventDetails_MakeInvoice():
        sse_encode_i_32(3, serializer);
      case NwcEventDetails_ListTransactions():
        sse_encode_i_32(4, serializer);
      case NwcEventDetails_GetBalance():
        sse_encode_i_32(5, serializer);
      case NwcEventDetails_GetInfo():
        sse_encode_i_32(6, serializer);
      case NwcEventDetails_ConnectionExpired():
        sse_encode_i_32(7, serializer);
      case NwcEventDetails_ConnectionRefreshed():
        sse_encode_i_32(8, serializer);
      case NwcEventDetails_ZapReceived(invoice: final invoice):
        sse_encode_i_32(9, serializer);
        sse_encode_String(invoice, serializer);
    }
  }
  ...
  @protected
  void sse_encode_opt_box_autoadd_description_hash(DescriptionHash? self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_description_hash(self, serializer);
    }
  }
  ...
  @protected
  void sse_encode_opt_box_autoadd_nostr_service_info(NostrServiceInfo? self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_nostr_service_info(self, serializer);
    }
  }
  ...
  @protected
  void sse_encode_opt_box_autoadd_periodic_budget(PeriodicBudget? self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_periodic_budget(self, serializer);
    }
  }

  @protected
  void sse_encode_opt_box_autoadd_periodic_budget_request(
    PeriodicBudgetRequest? self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_periodic_budget_request(self, serializer);
    }
  }
  ...
  @protected
  void sse_encode_periodic_budget(PeriodicBudget self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_u_64(self.usedBudgetSat, serializer);
    sse_encode_u_64(self.maxBudgetSat, serializer);
    sse_encode_opt_box_autoadd_u_32(self.renewsAt, serializer);
    sse_encode_u_32(self.updatedAt, serializer);
  }

  @protected
  void sse_encode_periodic_budget_request(PeriodicBudgetRequest self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_u_64(self.maxBudgetSat, serializer);
    sse_encode_opt_box_autoadd_u_32(self.renewalTimeMins, serializer);
  }

  @protected
  void sse_encode_plugin_storage_error(PluginStorageError self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case PluginStorageError_DataTooOld():
        sse_encode_i_32(0, serializer);
      case PluginStorageError_Encryption(err: final err):
        sse_encode_i_32(1, serializer);
        sse_encode_String(err, serializer);
      case PluginStorageError_Generic(err: final err):
        sse_encode_i_32(2, serializer);
        sse_encode_String(err, serializer);
    }
  }
  ...
  void sse_encode_prepare_send_request(PrepareSendRequest self, SseSerializer serializer) {
    ...
    sse_encode_opt_box_autoadd_u_64(self.paymentTimeoutSec, serializer);
  }
  ...
  void sse_encode_receive_payment_request(ReceivePaymentRequest self, SseSerializer serializer) {
    ...
    sse_encode_opt_String(self.description, serializer);
    sse_encode_opt_box_autoadd_description_hash(self.descriptionHash, serializer);
  ...
  @protected
  void sse_encode_record_string_nwc_connection((String, NwcConnection) self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.$1, serializer);
    sse_encode_nwc_connection(self.$2, serializer);
  }
  ...
  void sse_encode_sdk_error(SdkError self, SseSerializer serializer) {
    ...
    switch (self) {
      ...
      case SdkError_Generic(err: final err):
        sse_encode_i_32(1, serializer);
        sse_encode_String(err, serializer);
      case SdkError_NetworkNotSupported(network: final network):
        sse_encode_i_32(2, serializer);
...
@sealed
class BreezNwcServiceImpl extends RustOpaque implements BreezNwcService {
  // Not to be used by end users
  BreezNwcServiceImpl.frbInternalDcoDecode(List<dynamic> wire)
    : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  BreezNwcServiceImpl.frbInternalSseDecode(BigInt ptr, int externalSizeOnNative)
    : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        FlutterBreezLiquid.instance.api.rust_arc_increment_strong_count_BreezNwcService,
    rustArcDecrementStrongCount:
        FlutterBreezLiquid.instance.api.rust_arc_decrement_strong_count_BreezNwcService,
    rustArcDecrementStrongCountPtr:
        FlutterBreezLiquid.instance.api.rust_arc_decrement_strong_count_BreezNwcServicePtr,
  );

  Future<AddConnectionResponse> addConnection({required AddConnectionRequest req}) =>
      FlutterBreezLiquid.instance.api.crateNwcBreezNwcServiceAddConnection(that: this, req: req);

  Stream<NwcEvent> addEventListener() =>
      FlutterBreezLiquid.instance.api.crateNwcBreezNwcServiceAddEventListener(that: this);

  Future<EditConnectionResponse> editConnection({required EditConnectionRequest req}) =>
      FlutterBreezLiquid.instance.api.crateNwcBreezNwcServiceEditConnection(that: this, req: req);

  Future<NostrServiceInfo?> getInfo() =>
      FlutterBreezLiquid.instance.api.crateNwcBreezNwcServiceGetInfo(that: this);

  Future<void> handleEvent({required String rawEvent}) =>
      FlutterBreezLiquid.instance.api.crateNwcBreezNwcServiceHandleEvent(that: this, rawEvent: rawEvent);

  Future<String> id() => FlutterBreezLiquid.instance.api.crateNwcBreezNwcServiceId(that: this);

  Future<bool> isZap({required String invoice}) =>
      FlutterBreezLiquid.instance.api.crateNwcBreezNwcServiceIsZap(that: this, invoice: invoice);

  Future<List<Payment>> listConnectionPayments({required String name}) =>
      FlutterBreezLiquid.instance.api.crateNwcBreezNwcServiceListConnectionPayments(that: this, name: name);

  Future<Map<String, NwcConnection>> listConnections() =>
      FlutterBreezLiquid.instance.api.crateNwcBreezNwcServiceListConnections(that: this);

  Future<void> onStart({required PluginSdk pluginSdk, required PluginStorage storage}) => FlutterBreezLiquid
      .instance
      .api
      .crateNwcBreezNwcServiceOnStart(that: this, pluginSdk: pluginSdk, storage: storage);

  Future<void> onStop() => FlutterBreezLiquid.instance.api.crateNwcBreezNwcServiceOnStop(that: this);

  Future<void> removeConnection({required String name}) =>
      FlutterBreezLiquid.instance.api.crateNwcBreezNwcServiceRemoveConnection(that: this, name: name);

  Future<void> trackZap({required String invoice, required String zapRequest}) => FlutterBreezLiquid
      .instance
      .api
      .crateNwcBreezNwcServiceTrackZap(that: this, invoice: invoice, zapRequest: zapRequest);
}

@sealed
class BreezSdkLiquidImpl extends RustOpaque implements BreezSdkLiquid {
  // Not to be used by end users
  BreezSdkLiquidImpl.frbInternalDcoDecode(List<dynamic> wire)
    : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  BreezSdkLiquidImpl.frbInternalSseDecode(BigInt ptr, int externalSizeOnNative)
    : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        FlutterBreezLiquid.instance.api.rust_arc_increment_strong_count_BreezSdkLiquid,
    rustArcDecrementStrongCount:
        FlutterBreezLiquid.instance.api.rust_arc_decrement_strong_count_BreezSdkLiquid,
    rustArcDecrementStrongCountPtr:
        FlutterBreezLiquid.instance.api.rust_arc_decrement_strong_count_BreezSdkLiquidPtr,
  );

  Future<void> acceptPaymentProposedFees({required AcceptPaymentProposedFeesRequest req}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidAcceptPaymentProposedFees(that: this, req: req);

  Stream<SdkEvent> addEventListener() =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidAddEventListener(that: this);

  void backup({required BackupRequest req}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidBackup(that: this, req: req);

  Future<String> buyBitcoin({required BuyBitcoinRequest req}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidBuyBitcoin(that: this, req: req);

  CheckMessageResponse checkMessage({required CheckMessageRequest req}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidCheckMessage(that: this, req: req);

  Future<CreateBolt12InvoiceResponse> createBolt12Invoice({required CreateBolt12InvoiceRequest req}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidCreateBolt12Invoice(that: this, req: req);

  Future<void> disconnect() => FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidDisconnect(that: this);

  void emptyWalletCache() =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidEmptyWalletCache(that: this);

  Future<List<Rate>> fetchFiatRates() =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidFetchFiatRates(that: this);

  Future<LightningPaymentLimitsResponse> fetchLightningLimits() =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidFetchLightningLimits(that: this);

  Future<OnchainPaymentLimitsResponse> fetchOnchainLimits() =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidFetchOnchainLimits(that: this);

  Future<FetchPaymentProposedFeesResponse> fetchPaymentProposedFees({
    required FetchPaymentProposedFeesRequest req,
  }) => FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidFetchPaymentProposedFees(that: this, req: req);

  Future<GetInfoResponse> getInfo() =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidGetInfo(that: this);

  Future<Payment?> getPayment({required GetPaymentRequest req}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidGetPayment(that: this, req: req);

  Future<List<FiatCurrency>> listFiatCurrencies() =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidListFiatCurrencies(that: this);

  Future<List<Payment>> listPayments({required ListPaymentsRequest req}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidListPayments(that: this, req: req);

  Future<List<RefundableSwap>> listRefundables() =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidListRefundables(that: this);

  Future<LnUrlCallbackStatus> lnurlAuth({required LnUrlAuthRequestData reqData}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidLnurlAuth(that: this, reqData: reqData);

  Future<LnUrlPayResult> lnurlPay({required LnUrlPayRequest req}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidLnurlPay(that: this, req: req);

  Future<LnUrlWithdrawResult> lnurlWithdraw({required LnUrlWithdrawRequest req}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidLnurlWithdraw(that: this, req: req);

  Future<InputType> parse({required String input}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidParse(that: this, input: input);

  Future<SendPaymentResponse> payOnchain({required PayOnchainRequest req}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidPayOnchain(that: this, req: req);

  Future<PrepareBuyBitcoinResponse> prepareBuyBitcoin({required PrepareBuyBitcoinRequest req}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidPrepareBuyBitcoin(that: this, req: req);

  Future<PrepareLnUrlPayResponse> prepareLnurlPay({required PrepareLnUrlPayRequest req}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidPrepareLnurlPay(that: this, req: req);

  Future<PreparePayOnchainResponse> preparePayOnchain({required PreparePayOnchainRequest req}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidPreparePayOnchain(that: this, req: req);

  Future<PrepareReceiveResponse> prepareReceivePayment({required PrepareReceiveRequest req}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidPrepareReceivePayment(that: this, req: req);

  Future<PrepareRefundResponse> prepareRefund({required PrepareRefundRequest req}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidPrepareRefund(that: this, req: req);

  Future<PrepareSendResponse> prepareSendPayment({required PrepareSendRequest req}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidPrepareSendPayment(that: this, req: req);

  Future<ReceivePaymentResponse> receivePayment({required ReceivePaymentRequest req}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidReceivePayment(that: this, req: req);

  Future<RecommendedFees> recommendedFees() =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidRecommendedFees(that: this);

  Future<RefundResponse> refund({required RefundRequest req}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidRefund(that: this, req: req);

  Future<void> registerWebhook({required String webhookUrl}) => FlutterBreezLiquid.instance.api
      .crateSdkBreezSdkLiquidRegisterWebhook(that: this, webhookUrl: webhookUrl);

  Future<void> rescanOnchainSwaps() =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidRescanOnchainSwaps(that: this);

  void restore({required RestoreRequest req}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidRestore(that: this, req: req);

  Future<SendPaymentResponse> sendPayment({required SendPaymentRequest req}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidSendPayment(that: this, req: req);

  SignMessageResponse signMessage({required SignMessageRequest req}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidSignMessage(that: this, req: req);

  Future<void> sync() => FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidSync(that: this);

  Future<void> unregisterWebhook() =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidUnregisterWebhook(that: this);

  Future<BreezNwcService> useNwcPlugin({required NwcConfig config}) =>
      FlutterBreezLiquid.instance.api.crateSdkBreezSdkLiquidUseNwcPlugin(that: this, config: config);
}

@sealed
class PluginSdkImpl extends RustOpaque implements PluginSdk {
  // Not to be used by end users
  PluginSdkImpl.frbInternalDcoDecode(List<dynamic> wire) : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  PluginSdkImpl.frbInternalSseDecode(BigInt ptr, int externalSizeOnNative)
    : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount: FlutterBreezLiquid.instance.api.rust_arc_increment_strong_count_PluginSdk,
    rustArcDecrementStrongCount: FlutterBreezLiquid.instance.api.rust_arc_decrement_strong_count_PluginSdk,
    rustArcDecrementStrongCountPtr:
        FlutterBreezLiquid.instance.api.rust_arc_decrement_strong_count_PluginSdkPtr,
  );

  Stream<SdkEvent> addEventListener() =>
      FlutterBreezLiquid.instance.api.cratePluginPluginSdkAddEventListener(that: this);

  Future<GetInfoResponse> getInfo() =>
      FlutterBreezLiquid.instance.api.cratePluginPluginSdkGetInfo(that: this);

  Future<List<Payment>> listPayments({required ListPaymentsRequest req}) =>
      FlutterBreezLiquid.instance.api.cratePluginPluginSdkListPayments(that: this, req: req);

  Future<InputType> parse({required String input}) =>
      FlutterBreezLiquid.instance.api.cratePluginPluginSdkParse(that: this, input: input);

  Future<PrepareReceiveResponse> prepareReceivePayment({required PrepareReceiveRequest req}) =>
      FlutterBreezLiquid.instance.api.cratePluginPluginSdkPrepareReceivePayment(that: this, req: req);

  Future<PrepareSendResponse> prepareSendPayment({required PrepareSendRequest req}) =>
      FlutterBreezLiquid.instance.api.cratePluginPluginSdkPrepareSendPayment(that: this, req: req);

  Future<ReceivePaymentResponse> receivePayment({required ReceivePaymentRequest req}) =>
      FlutterBreezLiquid.instance.api.cratePluginPluginSdkReceivePayment(that: this, req: req);
...
@sealed
class PluginStorageImpl extends RustOpaque implements PluginStorage {
  // Not to be used by end users
  PluginStorageImpl.frbInternalDcoDecode(List<dynamic> wire) : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  PluginStorageImpl.frbInternalSseDecode(BigInt ptr, int externalSizeOnNative)
    : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        FlutterBreezLiquid.instance.api.rust_arc_increment_strong_count_PluginStorage,
    rustArcDecrementStrongCount:
        FlutterBreezLiquid.instance.api.rust_arc_decrement_strong_count_PluginStorage,
    rustArcDecrementStrongCountPtr:
        FlutterBreezLiquid.instance.api.rust_arc_decrement_strong_count_PluginStoragePtr,
  );

  String? getItem({required String key}) =>
      FlutterBreezLiquid.instance.api.cratePluginPluginStorageGetItem(that: this, key: key);

  void removeItem({required String key}) =>
      FlutterBreezLiquid.instance.api.cratePluginPluginStorageRemoveItem(that: this, key: key);

  void setItem({required String key, required String value, String? oldValue}) => FlutterBreezLiquid
      .instance
      .api
      .cratePluginPluginStorageSetItem(that: this, key: key, value: value, oldValue: oldValue);
}
