...
@freezed
sealed class DescriptionHash with _$DescriptionHash {
  const DescriptionHash._();

  const factory DescriptionHash.useDescription() = DescriptionHash_UseDescription;
  const factory DescriptionHash.custom({required String hash}) = DescriptionHash_Custom;
}
...
sealed class InputType with _$InputType {
  ...
  const factory InputType.nostrWalletConnectUri({required NostrWalletConnectUri data}) =
      InputType_NostrWalletConnectUri;
}
...
class NostrWalletConnectUri {
  final String walletServicePublicKey;
  ...
  const NostrWalletConnectUri({
    required this.walletServicePublicKey,
  ...
  @override
  int get hashCode =>
      walletServicePublicKey.hashCode ^
      appPublicKey.hashCode ^
      appSecret.hashCode ^
      relays.hashCode ^
      lud16.hashCode;
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is NostrWalletConnectUri &&
          runtimeType == other.runtimeType &&
          walletServicePublicKey == other.walletServicePublicKey &&
          appPublicKey == other.appPublicKey &&
...
enum PaymentMethod { bolt11Invoice, bolt12Offer, bitcoinAddress, liquidAddress }
...
class PrepareSendRequest {
  ...
  const PrepareSendRequest({required this.destination, this.amount, this.disableMrh, this.paymentTimeoutSec});

  @override
  int get hashCode =>
      destination.hashCode ^ amount.hashCode ^ disableMrh.hashCode ^ paymentTimeoutSec.hashCode;
...
class ReceivePaymentRequest {
  ...
  final String? description;
  final DescriptionHash? descriptionHash;
  ...
  @override
  int get hashCode =>
      prepareResponse.hashCode ^ description.hashCode ^ descriptionHash.hashCode ^ payerNote.hashCode;
